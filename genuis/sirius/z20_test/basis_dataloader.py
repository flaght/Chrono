...
spot_path = "/workspace/worker/pj/Chrono/genuis/mizar/records/ricso2/rbb/basic/train_data.feather"
future_path = "/workspace/worker/pj/Chrono/genuis/mizar/records/ricso2/mc/basic/train_data.feather"

df_lazy = load_basis_data(future_file_path=future_path, spot_file_path=spot_path)

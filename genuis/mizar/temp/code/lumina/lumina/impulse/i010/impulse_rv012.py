...
from lumina.impulse.i010.core.rv012 import rv012 as calc_rv012


class ImpulseRv012(ImpulseBase):
    ...
    def calc_impulse(self, kl_pd):
        ...
        for dk in self.rv011_keys:
            rv012_1, rv012_2 = calc_rv012(close=kl_pd['close'],
                                          threshold=dk[0],
                                          window=dk[1],
                                          weriod=dk[2],
            ...
            rv012_1 = self._format(rv012_1, name=name1)
            rv012_2 = self._format(rv012_2, name=name2)
            impulse_dict[name1] = rv012_1
            impulse_dict[name2] = rv012_2
        return impulse_dict

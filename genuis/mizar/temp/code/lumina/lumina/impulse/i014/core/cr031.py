...
def cr031(close, high, low, volume, threshold, window, weriod, ewm=False):
    ...
    # 三阶混合分位数（近似实现：三变量中心化后乘积的rolling分位数）
    ...
    #mix_quant = mix_prod.rolling(weriod).quantile(threshold)

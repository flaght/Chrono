...
from lumina.impulse.v001.core.hm001 import hm001 as calc_hm001
import pdb


class ImpulseHm001(ImpulseBase):
    """
    衡量龙虎榜上资金对{}日总成交的净影响，判断游资多空意图的核心指标。
    """
    ...
    def calc_impulse(self, kl_pd):
        ...
        for dk in self.ht001_keys:
            ht001 = calc_hm001(buy=kl_pd['buy'],
                               sell=kl_pd['sell'],
                               value=kl_pd['value'],
                               window=dk[0],
                               weriod=dk[1],

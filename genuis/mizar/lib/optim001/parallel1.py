...
def optimize_factors(column, n_trials, top_n, period, verbose, multi_objective,
                     ...
                     optimize_rule, objective_func,optimize_parameters,
    ...
    results = optimizer.optimize_expression(
        ...
        total_data1=total_data1,
        period=period,
        optimize_parameters=optimize_parameters, ## 参数寻优
        optimize_operators=optimize_operators, ## 算子寻优
        optimize_fields=optimize_fields, ## 特征寻优
        optimize_rule=optimize_rule,

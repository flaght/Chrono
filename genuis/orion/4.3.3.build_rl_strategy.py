...
from lib.rl033.train import train_model
from lib.rl033.predict import predict_test_set
from lib.rl033.signal import Config
from lib.rl033.analysis import create_evaluate, TopBottomParams

from lib.rl033.custom_feature import CrossSectionalExtractor
...
if __name__ == "__main__":
    ...
    df1 = pd.read_csv("./records/cicso0/temp/trl/1000301201/1075846004781919/metrics/results_nxt1_ret_1h_0.csv")
    top_bottom_params = [
        TopBottomParams(
            top_k=20,
            bottom_k=20,
    ...
    create_evaluate(df=df1, factor_name='score',
                       return_name='nxt1_ret',
                       top_bottom_params=top_bottom_params,
                       quantiles=5,
                       cost_rate=0.00035)

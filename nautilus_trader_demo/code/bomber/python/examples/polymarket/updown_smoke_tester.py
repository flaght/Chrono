...
from bomber.adapters.polymarket import PolymarketDataClientFactory
from bomber.adapters.polymarket import PolymarketExecClientConfig
from bomber.adapters.polymarket import PolymarketExecutionClientFactory
...
from bomber.adapters.polymarket import SignatureType
...
def request_gamma_events_by_slug(
    ...
    request = urllib.request.Request(url, headers={"User-Agent": "bomber"})  # noqa: S310

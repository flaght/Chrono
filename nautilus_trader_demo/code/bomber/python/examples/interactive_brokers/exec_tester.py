...
# -------------------------------------------------------------------------------------------------
"""
Interactive Brokers Python v2 execution tester example.
...
from bomber.adapters.interactive_brokers import InteractiveBrokersDataClientConfig
from bomber.adapters.interactive_brokers import InteractiveBrokersDataClientFactory
from bomber.adapters.interactive_brokers import InteractiveBrokersExecClientConfig
from bomber.adapters.interactive_brokers import InteractiveBrokersExecutionClientFactory
from bomber.adapters.interactive_brokers import MarketDataType
...
from bomber.testkit import ExecTesterConfig
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Build or run the Interactive Brokers Python v2 exec tester.",
    )

...
from bomber.model import PoolProfiler
from bomber.model import PoolSwap
from bomber.model import Token
from bomber.model import Transaction
...
def test_defi_public_module_names():
    assert Blockchain.__module__ == "bomber.model"
    assert Chain.__module__ == "bomber.model"
    assert Dex.__module__ == "bomber.model"
    assert DexType.__module__ == "bomber.model"

...
from bomber.common import Logger
from bomber.common import LogLevel
from bomber.common import init_tracing
from bomber.common import log_header
from bomber.common import log_sysinfo
from bomber.common import logger_flush
from bomber.common import logger_log
from bomber.common import logging_clock_set_realtime_mode
from bomber.common import logging_clock_set_static_mode
from bomber.common import logging_clock_set_static_time
from bomber.common import tracing_is_initialized
...
def test_init_tracing_before_logging_succeeds_in_fresh_process():
    script = textwrap.dedent(
        ...
        from bomber.common import LogLevel
        from bomber.common import init_logging
        from bomber.common import init_tracing
        from bomber.core import UUID4
        from bomber.model import TraderId

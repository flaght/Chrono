...
from bomber.core import NAUTILUS_USER_AGENT
from bomber.core import NAUTILUS_VERSION
from bomber.core import convert_to_snake_case
from bomber.core import is_pycapsule
from bomber.core import mask_api_key


def test_version_constants_are_consistent():
    assert NAUTILUS_VERSION
    assert f"Bomber/{NAUTILUS_VERSION}" == NAUTILUS_USER_AGENT

...
def fixup_module_names(namespace: dict, target_module: str) -> None:
    ...
    ``from bomber._libnautilus.<sub> import *``, the types land in the
...
def _should_fixup_module_name(
    ...
    if "bomber_pyo3" not in module and (
    ...
    return module.startswith("bomber._") or not module.startswith("bomber.")

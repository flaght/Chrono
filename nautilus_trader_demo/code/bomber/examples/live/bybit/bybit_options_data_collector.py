...
class BybitOptionsDataCollector(Strategy):
    ...
    def _setup_file_logging(self) -> None:
        ...
        """
        # Skip custom file logging setup - use Bomber's built-in logging
        ...
        # Log that file logging is handled by Bomber kernel
        self.log.info(f"File logging directory: {logs_dir}")
        self.log.info("File logging is handled by Bomber kernel configuration")

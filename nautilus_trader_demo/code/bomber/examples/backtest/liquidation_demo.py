...
# -------------------------------------------------------------------------------------------------
"""
Deterministic Liquidation Engine Demo - Bomber Issue #3788.
...
from bomber.core.bomber_pyo3.backtest import BacktestEngine
from bomber.core.bomber_pyo3.backtest import BacktestEngineConfig
from bomber.core.bomber_pyo3.model import AccountType
from bomber.core.bomber_pyo3.model import CryptoPerpetual
from bomber.core.bomber_pyo3.model import Currency
from bomber.core.bomber_pyo3.model import Money
from bomber.core.bomber_pyo3.model import OmsType
from bomber.core.bomber_pyo3.model import Price
from bomber.core.bomber_pyo3.model import Quantity
from bomber.core.bomber_pyo3.model import QuoteTick
from bomber.core.bomber_pyo3.model import Venue
from bomber.core.bomber_pyo3.trading import ImportableStrategyConfig as _ISC
...
def run_demo() -> dict:
    ...
    _log("-" * 60)
    _log("  Bomber - Deterministic Liquidation Engine Demo")
    ...
    engine.add_strategy_from_config(
        _ISC(
            strategy_path=(
                "bomber.examples.strategies.market_buy_on_start:MarketBuyOnStart"
            ),
            config_path=(
                "bomber.examples.strategies.market_buy_on_start:MarketBuyOnStartConfig"
            ),
            config={

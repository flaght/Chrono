...
if __name__ == "__main__":
    ...
    latency_model_config = ImportableLatencyModelConfig(
        latency_model_path="bomber.backtest.models:LatencyModel",
        config_path="bomber.backtest.config:LatencyModelConfig",
        config={
    ...
    maker_taker_fee_model_config = ImportableFeeModelConfig(
        fee_model_path="bomber.backtest.models:MakerTakerFeeModel",
        config_path="bomber.backtest.config:MakerTakerFeeModelConfig",
    ...
    fixed_fee_model_config = ImportableFeeModelConfig(
        fee_model_path="bomber.backtest.models:FixedFeeModel",
        config_path="bomber.backtest.config:FixedFeeModelConfig",
        config={
            "commission": "1.50 USD",
    ...
    per_contract_fee_model_config = ImportableFeeModelConfig(
        fee_model_path="bomber.backtest.models:PerContractFeeModel",
        config_path="bomber.backtest.config:PerContractFeeModelConfig",
        config={
            "commission": "0.01 USD",
        },
    )

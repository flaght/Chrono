...
from bomber.examples.strategies.ema_cross_bracket import EMACrossBracket
from bomber.examples.strategies.ema_cross_bracket import EMACrossBracketConfig

# <img src="https://github.com/nautechsystems/bomber/raw/develop/assets/bomber-logo.png" width="500">

[![codecov](https://codecov.io/gh/nautechsystems/bomber/branch/master/graph/badge.svg?token=DXO9QQI40H)](https://codecov.io/gh/nautechsystems/bomber)
[![codspeed](https://img.shields.io/endpoint?url=https://codspeed.io/badge.json)](https://codspeed.io/nautechsystems/bomber)
![pythons](https://img.shields.io/pypi/pyversions/bomber)
![pypi-version](https://img.shields.io/pypi/v/bomber)
![pypi-format](https://img.shields.io/pypi/format/bomber?color=blue)
[![Downloads](https://img.shields.io/pepy/dt/bomber?color=blue)](https://pepy.tech/projects/bomber)
[![Discord](https://img.shields.io/badge/Discord-%235865F2.svg?logo=discord&logoColor=white)](https://discord.gg/Bomber)

| Branch    | Version                                                                                                                                                                                                                     | Status                                                                                                                                                                                            |
| :-------- | :-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `master`  | [![version](https://img.shields.io/endpoint?url=https%3A%2F%2Fraw.githubusercontent.com%2Fnautechsystems%2Fbomber%2Fmaster%2Fversion.json)](https://packages.nautechsystems.io/simple/bomber/index.html)  | [![build](https://github.com/nautechsystems/bomber/actions/workflows/build.yml/badge.svg?branch=nightly)](https://github.com/nautechsystems/bomber/actions/workflows/build.yml) |
| `nightly` | [![version](https://img.shields.io/endpoint?url=https%3A%2F%2Fraw.githubusercontent.com%2Fnautechsystems%2Fbomber%2Fnightly%2Fversion.json)](https://packages.nautechsystems.io/simple/bomber/index.html) | [![build](https://github.com/nautechsystems/bomber/actions/workflows/build.yml/badge.svg?branch=nightly)](https://github.com/nautechsystems/bomber/actions/workflows/build.yml) |
| `develop` | [![version](https://img.shields.io/endpoint?url=https%3A%2F%2Fraw.githubusercontent.com%2Fnautechsystems%2Fbomber%2Fdevelop%2Fversion.json)](https://packages.nautechsystems.io/simple/bomber/index.html) | [![build](https://github.com/nautechsystems/bomber/actions/workflows/build.yml/badge.svg?branch=develop)](https://github.com/nautechsystems/bomber/actions/workflows/build.yml) |
...
Bomber is an open-source, production-grade, Rust-native engine for multi-asset,
...
Bomber is asset-class-agnostic. Any venue with a REST API or WebSocket feed can be
...
![bomber](https://github.com/nautechsystems/bomber/raw/develop/assets/bomber.png "bomber")
...
![nautilus](https://github.com/nautechsystems/bomber/raw/develop/assets/nautilus-art.png "nautilus")
...
Bomber removes this separation.
...
> [!NOTE]
>
> **MSRV:** Bomber relies heavily on improvements in the Rust language and compiler.
> As a result, the Minimum Supported Rust Version (MSRV) is generally equal to the latest stable release of Rust.

## Integrations

Bomber is modularly designed to work with *adapters*, enabling connectivity to trading venues
...
The [Roadmap](/ROADMAP.md) outlines Bomber's strategic direction.
...
[![OpenSSF Scorecard](https://api.scorecard.dev/projects/github.com/nautechsystems/bomber/badge)](https://scorecard.dev/viewer/?uri=github.com/nautechsystems/bomber)

Security is a priority for the Bomber project, and we value the work of those who help
...
[GitHub Security Advisories](https://github.com/nautechsystems/bomber/security/advisories/new),
...
> [!WARNING]
>
> **Bomber is still under active development**. Some features may be incomplete, and while
...
Bomber supports two precision modes for its core value types (`Price`, `Quantity`, `Money`),
...
We recommend using the latest supported version of Python and installing [bomber](https://pypi.org/project/bomber/) inside a virtual environment to isolate dependencies.
...
The Nautech Systems package index (`packages.nautechsystems.io`) complies with [PEP-503](https://peps.python.org/pep-0503/) and hosts both stable and development binary wheels for `bomber`.
This enables users to install either the latest stable release or pre-release versions for testing.

#### Stable wheels

Stable wheels correspond to official releases of `bomber` on PyPI, and use standard versioning.

To install the latest stable release:

```bash
pip install -U bomber --index-url=https://packages.nautechsystems.io/simple
```
...
```bash
pip install -U bomber --pre --index-url=https://packages.nautechsystems.io/simple
```

To install a specific development wheel (e.g., `1.221.0a20251026` for October 26, 2025):

```bash
pip install bomber==1.221.0a20251026 --index-url=https://packages.nautechsystems.io/simple
```

#### Available versions

You can view all available versions of `bomber` on the [package index](https://packages.nautechsystems.io/simple/bomber/index.html).

To programmatically fetch and list available versions:

```bash
curl -s https://packages.nautechsystems.io/simple/bomber/index.html | sed -n 's/.*<a href="\([^"]*\)".*/\1/p' | awk -F'#' '{print $1}' | sort
```
...
- Docker images (`ghcr.io/nautechsystems/bomber`, `ghcr.io/nautechsystems/jupyterlab`): keyless [cosign](https://github.com/sigstore/cosign) signatures plus SPDX SBOM attestations.
...
Bomber GitHub Actions workflow and has not been tampered with since.
...
5. Clone the source with `git`, and install from the project's root directory:
    ...
    ```bash
    git clone --branch develop --depth 1 https://github.com/nautechsystems/bomber
    cd bomber
    uv sync --all-extras
    ```
...
Using [Redis](https://redis.io) with Bomber is **optional** and only required if configured as the backend for a
...
> [!TIP]
>
> See the [crates/infrastructure/TESTS.md](https://github.com/nautechsystems/bomber/blob/develop/crates/infrastructure/TESTS.md) file for running the infrastructure integration tests.
...
- [indicator](/bomber/examples/indicators/ema_python.py) example written in Python.
- [indicator](/bomber/indicators/) implementations written in Cython.
- [strategy](/bomber/examples/strategies/) examples written in Python.
...
- `bomber:latest` has the latest release version installed.
- `bomber:nightly` has the head of the `nightly` branch installed.
...
[cargo-nextest](https://nexte.st) is the standard Rust test runner for Bomber.
...
Thank you for considering contributing to Bomber! We welcome any and all help to improve
the project. If you have an idea for an enhancement or a bug fix, the first step is to open an [issue](https://github.com/nautechsystems/bomber/issues)
...
outlined in the [CONTRIBUTING.md](https://github.com/nautechsystems/bomber/blob/develop/CONTRIBUTING.md) file. This includes signing a Contributor License Agreement (CLA)
...
Thank you again for your interest in Bomber! We look forward to reviewing your contributions and working with you to improve the project.

## Community

Join our community of users and contributors on [Discord](https://discord.gg/Bomber) to chat
and stay up-to-date with the latest announcements and features of Bomber. Whether you're a
developer looking to contribute or just want to learn more about the platform, all are welcome on our Discord server.

> [!WARNING]
>
> Bomber does not issue, promote, or endorse any cryptocurrency tokens. Any claims or communications suggesting otherwise are unauthorized and false.
>
> All official updates and communications from Bomber will be shared exclusively through <https://nautilustrader.io>, our [GitHub](https://github.com/nautechsystems), our [Discord server](https://discord.gg/Bomber), or our verified X (Twitter) account: [@Bomber](https://x.com/Bomber).
>
...
The source code for Bomber is available on GitHub under the [GNU Lesser General Public License v3.0](https://www.gnu.org/licenses/lgpl-3.0.en.html).
Contributions to the project are welcome and require the completion of a standard [Contributor License Agreement (CLA)](https://github.com/nautechsystems/bomber/blob/develop/CLA.md).

---

Bomber™ is developed and maintained by Nautech Systems, a technology
...
![nautechsystems](https://github.com/nautechsystems/bomber/raw/develop/assets/ns-logo.png "nautechsystems")
<img src="https://github.com/nautechsystems/bomber/raw/develop/assets/ferris.png" width="128">

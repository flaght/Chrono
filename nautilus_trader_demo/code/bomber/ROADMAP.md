...
This document outlines the key priorities and upcoming goals for **Bomber**,
...
For real-time updates and detailed task tracking, refer to the [Bomber Kanban board](https://github.com/orgs/nautechsystems/projects/3).
...
To establish Bomber as the default open trading engine for quantitative algorithmic
...
The Bomber open-source project is purpose-built to empower individual and
...
Integrations must also align with Bomber’s professional, performance-focused, and high-reliability philosophy.
...
Bomber is an open-core project. All core trading engine
...
## Bomber v2.0 and beyond

- **Achieving Stable Status**: While Bomber is already successfully used in production, v2.0 represents a significant milestone toward establishing a stable API.
...
- **Python API Commitment**: Despite transitioning the core to Rust, Bomber will continue to provide a user-facing Python API.

## Charting the future

This roadmap builds on Bomber’s strong foundation, driving continuous refinement while

...
alongside every option ticker update. Bomber exposes this data at
two levels:
...
This aggregation happens inside Bomber. Bybit publishes
...
- [`crates/adapters/bybit/examples/node_greeks.rs`](https://github.com/nautechsystems/bomber/tree/develop/crates/adapters/bybit/examples/node_greeks.rs)
- [`crates/adapters/bybit/examples/node_option_chain.rs`](https://github.com/nautechsystems/bomber/tree/develop/crates/adapters/bybit/examples/node_option_chain.rs)

...
```python
from bomber.examples.strategies.grid_market_maker import GridMarketMaker
from bomber.examples.strategies.grid_market_maker import GridMarketMakerConfig
...
[`bitmex_grid_market_maker.py`](https://github.com/nautechsystems/bomber/tree/develop/examples/backtest/bitmex_grid_market_maker.py).
...
[`node_grid_mm.rs`](https://github.com/nautechsystems/bomber/tree/develop/crates/adapters/bitmex/examples/node_grid_mm.rs):

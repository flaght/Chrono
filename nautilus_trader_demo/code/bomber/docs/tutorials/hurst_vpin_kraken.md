...
[`HurstVpinDirectional`](https://github.com/nautechsystems/bomber/tree/develop/crates/trading/src/examples/strategies/hurst_vpin_directional)
...
bars (`VALUE` aggregation in Bomber) close after a fixed
...
- The Bomber repository cloned and building.
...
[`CryptoPerpetual`](https://github.com/nautechsystems/bomber/blob/develop/crates/model/src/instruments/crypto_perpetual.rs).
...
Bomber ships all the information-driven bar aggregators from
...
engine to aggregate inside Bomber from the underlying trade
...
- [`HurstVpinDirectional` strategy source](https://github.com/nautechsystems/bomber/tree/develop/crates/trading/src/examples/strategies/hurst_vpin_directional)

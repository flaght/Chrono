...
Bomber ships `BookImbalanceActor` in the trading crate's examples
...
[`crates/trading/src/examples/actors/imbalance/actor.rs`](https://github.com/nautechsystems/bomber/tree/develop/crates/trading/src/examples/actors/imbalance/actor.rs).
...
[`crates/adapters/betfair/examples/betfair_backtest.rs`](https://github.com/nautechsystems/bomber/tree/develop/crates/adapters/betfair/examples/betfair_backtest.rs).

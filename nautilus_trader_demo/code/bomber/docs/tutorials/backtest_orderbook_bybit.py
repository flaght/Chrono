...
# [Binance variant](https://github.com/nautechsystems/bomber/blob/develop/docs/tutorials/backtest_orderbook_binance.py),
# different loader and different instrument.
#
# [View source on GitHub](https://github.com/nautechsystems/bomber/blob/develop/docs/tutorials/backtest_orderbook_bybit.py).

...
# Bomber test kit, so this tutorial runs without any external download.
#
# [View source on GitHub](https://github.com/nautechsystems/bomber/blob/develop/docs/tutorials/backtest_fx_bars.py).
...
#   (`pip install bomber`). The `visualization` extra is only needed

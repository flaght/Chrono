...
- **Relative Strength Index** (`RSI(14)`): a 14-bar momentum oscillator.
  Bomber RSI is on `[0, 1]`, so the conventional 30/70 thresholds
  become `0.30` / `0.70`.
...
| `rsi_buy_threshold`  | `0.30` | Long entry confirmation (Bomber RSI is `[0, 1]`). |
| `rsi_sell_threshold` | `0.70` | Short entry confirmation.                            |
| `trade_size`         | `1`    | One contract per trade (1,000 EUR notional).         |

:::tip
Bomber RSI returns values in `[0.0, 1.0]`, not `[0, 100]`. The
...
from bomber.examples.strategies.bb_mean_reversion import BBMeanReversion
from bomber.examples.strategies.bb_mean_reversion import BBMeanReversionConfig
...
[`architect_ax_mean_reversion.py`](https://github.com/nautechsystems/bomber/tree/develop/examples/backtest/architect_ax_mean_reversion.py).
...
[`ax_mean_reversion.py`](https://github.com/nautechsystems/bomber/tree/develop/examples/live/architect_ax/ax_mean_reversion.py).
...
- [`BBMeanReversion` strategy source](https://github.com/nautechsystems/bomber/tree/develop/bomber/examples/strategies/bb_mean_reversion.py)

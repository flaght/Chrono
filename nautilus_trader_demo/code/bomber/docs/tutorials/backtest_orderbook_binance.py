...
#
# [View source on GitHub](https://github.com/nautechsystems/bomber/blob/develop/docs/tutorials/backtest_orderbook_binance.py).
...
# `OrderBookImbalance` strategy ships in `bomber.examples` and works
...
#
# - Python 3.12+
# - [Bomber](https://pypi.org/project/bomber/) installed
#   (`pip install bomber`)
...
from bomber.backtest.node import BacktestDataConfig
from bomber.backtest.node import BacktestEngineConfig
from bomber.backtest.node import BacktestNode
from bomber.backtest.node import BacktestRunConfig
from bomber.backtest.node import BacktestVenueConfig
...
# event. The Binance loader maps them to Bomber `OrderBookDelta`

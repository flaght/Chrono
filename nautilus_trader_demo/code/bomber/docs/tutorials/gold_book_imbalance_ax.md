...
[`architect_ax_book_imbalance.py`](https://github.com/nautechsystems/bomber/tree/develop/examples/backtest/architect_ax_book_imbalance.py).
...
[`ax_book_imbalance.py`](https://github.com/nautechsystems/bomber/tree/develop/examples/live/architect_ax/ax_book_imbalance.py).
...
- [`OrderBookImbalance` strategy source](https://github.com/nautechsystems/bomber/tree/develop/bomber/examples/strategies/orderbook_imbalance.py)

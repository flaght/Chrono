...
allow Bomber to redistribute the data through the public repo or the public R2 bucket.
...
2. The function should: download, parse, filter, convert to Bomber types, write Parquet.
...
For datasets that Bomber cannot redistribute:

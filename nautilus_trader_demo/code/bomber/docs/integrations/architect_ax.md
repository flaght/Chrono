...
You can find live example scripts [here](https://github.com/nautechsystems/bomber/tree/develop/examples/live/architect_ax/).
...
In Bomber, all AX instruments are represented as `PerpetualContract`, an asset-class
...
```python
from bomber.adapters.architect_ax import AX
from bomber.adapters.architect_ax import AxDataClientConfig
from bomber.adapters.architect_ax import AxEnvironment
from bomber.adapters.architect_ax import AxExecClientConfig
...
```python
from bomber.adapters.architect_ax import AX
from bomber.adapters.architect_ax import AxLiveDataClientFactory
from bomber.adapters.architect_ax import AxLiveExecClientFactory
...
- **Unfilled IOC/FOK**: AX reports an unfilled immediate order as an expiry; the adapter maps
  it to `OrderCanceled` to match Bomber semantics.

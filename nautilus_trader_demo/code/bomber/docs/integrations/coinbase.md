...
PyO3 surface available from `bomber.core.bomber_pyo3.coinbase`:
...
with this Bomber integration guide.
...
```python
from bomber.core.bomber_pyo3 import CoinbaseDataClientConfig
from bomber.core.bomber_pyo3 import CoinbaseExecClientConfig
from bomber.core.bomber_pyo3 import CoinbaseEnvironment
...
our [contributing guide](https://github.com/nautechsystems/bomber/blob/develop/CONTRIBUTING.md).
:::

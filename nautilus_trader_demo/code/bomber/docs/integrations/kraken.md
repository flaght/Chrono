...
[examples/live/kraken]: https://github.com/nautechsystems/bomber/tree/develop/examples/live/kraken/
...
Refer to the Kraken documentation in conjunction with this Bomber
integration guide.
...
Bomber uses ISO 4217-A3 format for Kraken Spot instrument symbols,
...
venue order ID into the `u64` `BookOrder.order_id` field used by Bomber.
...
```python
from bomber.adapters.kraken import KrakenExecClientConfig
...
```python
from bomber.adapters.kraken import KRAKEN
from bomber.adapters.kraken import KrakenEnvironment
from bomber.adapters.kraken import KrakenProductType
...
```python
from bomber.adapters.kraken import KRAKEN
from bomber.adapters.kraken import KrakenDataClientFactory
from bomber.adapters.kraken import KrakenExecutionClientFactory
from bomber.live.node import TradingNode

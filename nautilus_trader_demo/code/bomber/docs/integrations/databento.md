...
Bomber includes an adapter for the [Databento](https://databento.com/) API
and for data in
...
See the [live examples](https://github.com/nautechsystems/bomber/tree/develop/examples/live/databento/).

Rust examples live under
[`crates/adapters/databento/examples/`](https://github.com/nautechsystems/bomber/tree/develop/crates/adapters/databento/examples/).
...
The following Databento schemas are supported by Bomber:
...
```python
from bomber.adapters.databento import DATABENTO_CLIENT_ID
...
```python
from bomber.adapters.databento import DATABENTO_CLIENT_ID
from bomber.adapters.databento import DatabentoImbalance
from bomber.adapters.databento import DatabentoStatistics

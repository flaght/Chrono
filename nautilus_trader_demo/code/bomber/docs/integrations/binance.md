...
Bomber provides Binance integration in both Python and Rust. The Rust
...
- [Python live examples](https://github.com/nautechsystems/bomber/tree/develop/examples/live/binance/)
- [Rust spot examples](https://github.com/nautechsystems/bomber/tree/develop/crates/adapters/binance/examples/spot/)
- [Rust futures examples](https://github.com/nautechsystems/bomber/tree/develop/crates/adapters/binance/examples/futures/)
...
Because Bomber supports multi-venue trading, it must distinguish between
...
The Bomber integration ID is automatically prefixed to all
...
```python
from bomber.core import bomber_pyo3 as pyo3
...
```python
from bomber.adapters.binance import BinanceFuturesMarkPriceUpdate
...
```python
from bomber.adapters.binance import BINANCE
...
```python
from bomber.adapters.binance import BINANCE
from bomber.adapters.binance import BinanceLiveDataClientFactory
from bomber.adapters.binance import BinanceLiveExecClientFactory
from bomber.live.node import TradingNode
...
`bomber.core.bomber_pyo3.binance`; not on the legacy Python adapter config.
:::
...
superior performance and security. A future version of Bomber will
...
```python
from bomber.adapters.binance import BinanceInstrumentProviderConfig

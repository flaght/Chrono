...
You can find live example scripts [here](https://github.com/nautechsystems/bomber/tree/develop/examples/live/bitmex/).
...
### Bomber instrument IDs

Within Bomber, BitMEX instruments are identified using the native BitMEX symbol
...
:::note
BitMEX spot symbols in Bomber don't include the slash (/) that appears in the

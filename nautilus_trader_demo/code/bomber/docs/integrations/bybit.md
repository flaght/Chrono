...
You can find live example scripts [here](https://github.com/nautechsystems/bomber/tree/develop/examples/live/bybit/).
...
It’s recommended you also refer to the Bybit documentation in conjunction with this Bomber integration guide.
...
- The WebSocket Trade API is **not supported** for demo trading. Bomber automatically uses the HTTP REST API for order operations in demo mode.
...
```python
from bomber.adapters.bybit import BybitPositionMode
...
[bybit_exec_tester.py](https://github.com/nautechsystems/bomber/tree/develop/examples/live/bybit/bybit_exec_tester.py) example.

## Spot margin borrowing and repayment

Bomber provides automated spot margin borrow repayment functionality to prevent interest accrual after closing short positions on Bybit.
...
Bomber automatically repays spot margin borrows immediately after BUY orders fill on Spot instruments.
...
```python
from bomber.adapters.bybit import BybitExecClientConfig
...
```python
from bomber.adapters.bybit import BybitMarginAction
from bomber.adapters.bybit import BybitMarginBorrowResult
from bomber.adapters.bybit import BybitMarginRepayResult
from bomber.adapters.bybit import BybitMarginStatusResult
...
Bybit blocks `no-convert-repay` operations daily during **04:00-05:30 UTC** for interest calculation processing. Bomber automatically detects this window and skips repayment attempts, logging a warning instead.
...
step-by-step walkthrough. Bomber builds the option chain view locally
...
```python
from bomber.adapters.bybit import BYBIT
from bomber.adapters.bybit import BybitEnvironment
from bomber.adapters.bybit import BybitProductType
from bomber.live.node import TradingNode
from bomber.live.node import TradingNodeConfig
...
```python
from bomber.adapters.bybit import BYBIT
from bomber.adapters.bybit import BybitLiveDataClientFactory
from bomber.adapters.bybit import BybitLiveExecClientFactory
from bomber.live.node import TradingNode

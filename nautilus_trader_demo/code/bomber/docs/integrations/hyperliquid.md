...
You can find live example scripts [here](https://github.com/nautechsystems/bomber/tree/develop/examples/live/hyperliquid/).

## Builder code attribution

Submitted mainnet orders carry the Bomber builder code at a **zero fee rate**, so
...
```python
from bomber.adapters.hyperliquid import HyperliquidExecClientConfig
...
```python
from bomber.adapters.hyperliquid import builder_fee_approve
...
```python
from bomber.adapters.hyperliquid import builder_fee_revoke
...
To use your testnet account with Bomber, you need to export your wallet's private key:
...
though orders are live on the venue. See [GH-4010](https://github.com/nautechsystems/bomber/issues/4010).
:::
...
```python
from bomber.adapters.hyperliquid import HyperliquidEnvironment
from bomber.adapters.hyperliquid import HyperliquidHttpClient
...
from bomber.core.bomber_pyo3 import HyperliquidEnvironment
from bomber.core.bomber_pyo3 import HyperliquidHttpClient
...
```python
from bomber.model.data import BookType
...
```python
from bomber.adapters.hyperliquid import HYPERLIQUID_CLIENT_ID
from bomber.adapters.hyperliquid import HyperliquidOpenInterest
from bomber.model.data import DataType
...
```python
from bomber.adapters.hyperliquid import HYPERLIQUID_CLIENT_ID
from bomber.adapters.hyperliquid import HyperliquidAllDexsAssetCtxs
from bomber.model.data import DataType
...
:::info
Orders placed outside Bomber (e.g. via the Hyperliquid web UI or another client)
...
Rust side via the
[`WsDispatchState`](https://github.com/nautechsystems/bomber/tree/develop/crates/adapters/hyperliquid/src/websocket/dispatch.rs)
...
`oid` and translates to `OrderUpdated`. See [GH-3827](https://github.com/nautechsystems/bomber/issues/3827).
...
[GH-4270](https://github.com/nautechsystems/bomber/issues/4270).
...
[GH-3972](https://github.com/nautechsystems/bomber/issues/3972).
...
```python
from bomber.adapters.hyperliquid import HYPERLIQUID
from bomber.adapters.hyperliquid import HyperliquidDataClientConfig
from bomber.adapters.hyperliquid import HyperliquidEnvironment
from bomber.adapters.hyperliquid import HyperliquidExecClientConfig
...
```python
from bomber.adapters.hyperliquid import HYPERLIQUID
from bomber.adapters.hyperliquid import HyperliquidDataClientFactory
from bomber.adapters.hyperliquid import HyperliquidExecutionClientFactory

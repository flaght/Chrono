...
Bomber provides specialized value types for representing core trading concepts:
...
```python
from bomber.model.objects import Price, Quantity, Money
...
from bomber.model.currencies import USD, EUR
...
```python
from bomber.model.objects import Quantity, Price, Money

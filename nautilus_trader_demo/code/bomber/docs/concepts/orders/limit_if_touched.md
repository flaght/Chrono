...
See the [`LimitIfTouchedOrder` API Reference](/docs/python-api-latest/model/orders.html#bomber.model.orders.limit_if_touched.LimitIfTouchedOrder) for further details.

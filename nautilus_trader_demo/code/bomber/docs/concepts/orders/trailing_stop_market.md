...
See the [`TrailingStopMarketOrder` API Reference](/docs/python-api-latest/model/orders.html#bomber.model.orders.trailing_stop_market.TrailingStopMarketOrder) for further details.

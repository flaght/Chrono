...
See the [`TrailingStopLimitOrder` API Reference](/docs/python-api-latest/model/orders.html#bomber.model.orders.trailing_stop_limit.TrailingStopLimitOrder) for further details.

...
:::info
The default backtest venue for Bomber uses a *partial-trigger model* for OTO orders.
...
Bracket orders can be easily created using the [OrderFactory](/docs/python-api-latest/common.html#bomber.common.factories.OrderFactory),

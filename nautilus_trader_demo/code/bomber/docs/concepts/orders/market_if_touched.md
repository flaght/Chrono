...
See the [`MarketIfTouchedOrder` API Reference](/docs/python-api-latest/model/orders.html#bomber.model.orders.market_if_touched.MarketIfTouchedOrder) for further details.

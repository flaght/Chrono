...
This guide explains how positions work in Bomber, including their lifecycle, aggregation
...
Bomber supports two primary OMS types that fundamentally affect how positions are tracked
...
Bomber provides PnL calculations that account for instrument
...
[API Reference](/docs/python-api-latest/model/position.html#bomber.model.position.Position).
:::

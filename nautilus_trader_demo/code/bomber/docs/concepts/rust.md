...
- **v1 legacy**: Cython/Python classes under `bomber/`. Fully
...
```toml
[dependencies]
nautilus-backtest = { git = "https://github.com/nautechsystems/bomber.git", branch = "develop" }
nautilus-common = { git = "https://github.com/nautechsystems/bomber.git", branch = "develop" }
nautilus-execution = { git = "https://github.com/nautechsystems/bomber.git", branch = "develop" }
nautilus-model = { git = "https://github.com/nautechsystems/bomber.git", branch = "develop", features = ["stubs"] }
nautilus-trading = { git = "https://github.com/nautechsystems/bomber.git", branch = "develop", features = ["examples"] }
```
...
[`BookImbalanceActor`](https://github.com/nautechsystems/bomber/tree/develop/crates/trading/src/examples/actors/imbalance).
...
[`EmaCross`](https://github.com/nautechsystems/bomber/tree/develop/crates/trading/src/examples/strategies/ema_cross)
and
[`GridMarketMaker`](https://github.com/nautechsystems/bomber/tree/develop/crates/trading/src/examples/strategies/grid_mm).
...
```python
from bomber.core.bomber_pyo3.trading import GridMarketMakerConfig
...
Source:
[`crates/backtest/examples/engine_ema_cross.rs`](https://github.com/nautechsystems/bomber/tree/develop/crates/backtest/examples/engine_ema_cross.rs)
...
Source:
[`crates/backtest/examples/node_ema_cross.rs`](https://github.com/nautechsystems/bomber/tree/develop/crates/backtest/examples/node_ema_cross.rs)

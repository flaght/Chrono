...
Bomber provides a high-performance order book implemented in Rust, capable of
...
PyO3 bindings (`bomber_pyo3.OrderBook`, `bomber_pyo3.OwnOrderBook`). The v1 legacy
Cython `OrderBook` (`bomber.model.book.OrderBook`) returned by

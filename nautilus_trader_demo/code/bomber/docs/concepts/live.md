...
Bomber deploys backtested strategies to live markets with no code changes.
...
For all live trading options, see the `LiveExecEngineConfig` [API Reference](/docs/python-api-latest/config.html#bomber.live.config.LiveExecEngineConfig).

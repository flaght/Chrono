...
Bomber provides interactive HTML tearsheets for analyzing backtest results through
...
```bash
uv pip install "bomber[visualization]"
```
...
from bomber.analysis import TearsheetDrawdownChart
from bomber.analysis import TearsheetEquityChart
from bomber.analysis import TearsheetRunInfoChart
...
Bomber provides four built-in themes:
...
| `nautilus`      | Light theme with Bomber brand colors.  | Official light mode.           |
...
```python
from bomber.analysis import GridLayout
from bomber.analysis import TearsheetConfig
from bomber.analysis import TearsheetDrawdownChart
from bomber.analysis import TearsheetEquityChart
from bomber.analysis import TearsheetStatsTableChart

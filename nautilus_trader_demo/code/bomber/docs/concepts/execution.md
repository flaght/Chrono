...
Bomber can handle trade execution and order management for multiple strategies and venues
...
See the [`RiskEngineConfig` API Reference](/docs/python-api-latest/config.html#bomber.risk.config.RiskEngineConfig) for further details.
...
`bomber/examples/algorithms/twap.py`), this example demonstrates how to initialize and
...
from bomber.examples.strategies.ema_cross_twap import EMACrossTWAP, EMACrossTWAPConfig

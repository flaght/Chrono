...
See the `LoggingConfig` [API Reference](/docs/python-api-latest/config.html#bomber.common.config.LoggingConfig) for further details.
...
This issue is tracked in GitHub [issue #3027](https://github.com/nautechsystems/bomber/issues/3027).

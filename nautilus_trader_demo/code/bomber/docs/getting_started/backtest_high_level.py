...
#
# [View source on GitHub](https://github.com/nautechsystems/bomber/blob/develop/docs/getting_started/backtest_high_level.py).

# %% [markdown]
# ## Prerequisites
# - Python 3.12+
# - [Bomber](https://pypi.org/project/bomber/) latest release installed (`pip install bomber`)

...
Bomber provides two API levels for backtesting:
...
| Directory                                                                                                | Contains                                                      |
|:---------------------------------------------------------------------------------------------------------|:--------------------------------------------------------------|
| [examples/](https://github.com/nautechsystems/bomber/tree/develop/examples)                     | Fully runnable, self‑contained Python examples                |
...
| [bomber/examples/](../../bomber/examples/)                                              | Pure‑Python examples of strategies, indicators, and exec algos|
...
Bomber with no local setup. Deleting the container deletes any data.

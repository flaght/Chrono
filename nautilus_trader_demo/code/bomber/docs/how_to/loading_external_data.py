...
# external vendor that is not directly supported by a Bomber adapter.
#
# [View source on GitHub](https://github.com/nautechsystems/bomber/blob/develop/docs/how_to/loading_external_data.py).
...
from bomber.test_kit.providers import CSVTickDataLoader

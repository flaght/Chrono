...
[API Reference](/docs/python-api-latest/config.html#bomber.live.config.LiveExecEngineConfig).
...
[API Reference](/docs/python-api-latest/config.html#bomber.trading.config.StrategyConfig).
...
[#2785](https://github.com/nautechsystems/bomber/issues/2785).

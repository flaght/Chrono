...
github_repository="${GITHUB_REPOSITORY:-nautechsystems/bomber}"
...
pypi_project="${PYPI_PROJECT:-bomber}"
...
cargo_publish_user_agent="${CARGO_PUBLISH_USER_AGENT:-bomber-release-verifier}"

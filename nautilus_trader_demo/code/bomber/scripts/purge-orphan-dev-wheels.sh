...
PREFIX="${CLOUDFLARE_R2_PREFIX:-simple/bomber}"
PREFIX="${PREFIX%/}"
APPLY=false
case "${1:-}" in
  "")
...
if [[ "$APPLY" == true ]]; then
  if [[ -z "$REPO_ROOT" || ! -d "$REPO_ROOT" ]]; then
    echo "ERROR: could not find repo root. Set REPO_ROOT=/path/to/bomber" >&2
    exit 1
  fi
  ...
  if compgen -G "${REPO_ROOT}/dist/bomber-*.whl" > /dev/null; then
...
ORPHANS=(
  "bomber-1.221.0.dev20251026+11610-cp311-cp311-macosx_15_0_arm64.whl"
  "bomber-1.221.0.dev20251026+11610-cp311-cp311-manylinux_2_35_x86_64.whl"
  "bomber-1.221.0.dev20251026+11610-cp311-cp311-win_amd64.whl"
  "bomber-1.226.0.dev20260418+14628-cp312-cp312-win_amd64.whl"
  "bomber-1.226.0.dev20260418+14628-cp313-cp313-win_amd64.whl"
  "bomber-1.226.0.dev20260418+14628-cp314-cp314-win_amd64.whl"
  "bomber-1.226.0.dev20260428+14797-cp312-cp312-macosx_15_0_arm64.whl"
  "bomber-1.226.0.dev20260428+14797-cp313-cp313-macosx_15_0_arm64.whl"
  "bomber-1.226.0.dev20260428+14797-cp314-cp314-macosx_15_0_arm64.whl"
  "bomber-1.226.0.dev20260428+14798-cp312-cp312-manylinux_2_35_aarch64.whl"
  "bomber-1.226.0.dev20260428+14798-cp313-cp313-manylinux_2_35_aarch64.whl"
  "bomber-1.226.0.dev20260428+14798-cp314-cp314-manylinux_2_35_aarch64.whl"
)

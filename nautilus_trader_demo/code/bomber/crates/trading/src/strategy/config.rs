...
#[cfg_attr(
    feature = "python",
    pyo3::pyclass(
        module = "bomber.core.bomber_pyo3.trading",
        subclass,
        from_py_object
    )
)]
#[cfg_attr(
    feature = "python",
    pyo3_stub_gen::derive::gen_stub_pyclass(module = "bomber.trading")
)]
...
#[cfg_attr(
    feature = "python",
    pyo3::pyclass(module = "bomber.core.bomber_pyo3.trading", from_py_object)
)]
#[cfg_attr(
    feature = "python",
    pyo3_stub_gen::derive::gen_stub_pyclass(module = "bomber.trading")

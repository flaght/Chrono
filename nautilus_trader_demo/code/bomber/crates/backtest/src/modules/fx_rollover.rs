...
#[cfg_attr(
    feature = "python",
    pyo3::pyclass(module = "bomber.core.bomber_pyo3.backtest", from_py_object)
)]
#[cfg_attr(
    feature = "python",
    pyo3_stub_gen::derive::gen_stub_pyclass(module = "bomber.backtest")
)]
...
#[cfg_attr(
    feature = "python",
    pyo3::pyclass(
        module = "bomber.core.bomber_pyo3.backtest",
        unsendable,
        skip_from_py_object
    )
)]

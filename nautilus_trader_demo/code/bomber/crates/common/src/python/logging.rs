...
/// the components in the [bomber](https://pypi.org/project/bomber) package.
...
#[pyfunction]
#[pyo3_stub_gen::derive::gen_stub_pyfunction(module = "bomber.common")]
...
#[pyclass(
    module = "bomber.core.bomber_pyo3.common",
    name = "Logger",
    unsendable,
    from_py_object
)]

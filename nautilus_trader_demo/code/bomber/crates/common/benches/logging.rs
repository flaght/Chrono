...
const COMPONENT: &str = "bomber::adapters::binance::execution";
...
const COMPONENT_TARGETS_12: [&str; 12] = [
    "bomber::adapters::binance::execution",
    "bomber::adapters::bybit::execution",
    "bomber::adapters::okx::execution",
    "bomber::adapters::coinbase::execution",
    "bomber::adapters::kraken::execution",
    "bomber::adapters::bitmex::execution",
    "bomber::adapters::deribit::execution",
    "bomber::adapters::dydx::execution",
    "bomber::adapters::hyperliquid::execution",
    "bomber::adapters::databento::execution",
    "bomber::adapters::betfair::execution",
    "bomber::adapters::sandbox::execution",
];
...
fn bench_filtering(c: &mut Criterion) {
    ...
    let mut module_filters = vec![
        (Ustr::from("bomber::adapters"), LevelFilter::Info),
        (
            Ustr::from("bomber::adapters::binance"),
            LevelFilter::Warn,
        ),
        (Ustr::from("bomber::common"), LevelFilter::Debug),
        (Ustr::from("bomber::core"), LevelFilter::Info),
        (Ustr::from("bomber::data"), LevelFilter::Info),
        (Ustr::from("bomber::execution"), LevelFilter::Debug),
        (Ustr::from("bomber::model"), LevelFilter::Info),
        (Ustr::from("bomber::portfolio"), LevelFilter::Debug),
    ];

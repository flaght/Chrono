...
//! combinations of features and target environments supported by Bomber.
//!
...
fn main() {
    ...
    let nautilus_version = "1.230.0"; // Hardcode to avoid including pyproject.toml in package
    ...
    println!("cargo:rustc-env=NAUTILUS_USER_AGENT=Bomber/{nautilus_version}");
    ...
    if env::var("CARGO_FEATURE_FFI").is_ok() {
        ...
        let c_header_path = crate_dir.join("../../bomber/core/includes/core.h");
        ...
        let cython_path = crate_dir.join("../../bomber/core/rust/core.pxd");

...
//! `python` feature flag. It provides thin adapters so that Bomber functionality can be
//! consumed from the `bomber` Python package without sacrificing type-safety or
//! performance.
...
#[gen_stub_pyfunction(module = "bomber.core")]
#[expect(
    clippy::needless_pass_by_value,

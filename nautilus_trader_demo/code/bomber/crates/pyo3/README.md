...
Python bindings for [Bomber](https://nautilustrader.io).

The `bomber-pyo3` crate provides all [PyO3](https://pyo3.rs) Python bindings for the
main `bomber` Python package, built via [maturin](https://github.com/PyO3/maturin).

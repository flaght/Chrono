...
//! Python bindings aggregator crate for [Bomber](https://nautilustrader.io).
//!
//! The `bomber-pyo3` crate collects the Python bindings generated across the Bomber workspace
...
///
/// Also re-exports all submodule attributes so they can be imported directly from `bomber_pyo3`
/// refer: <https://github.com/PyO3/pyo3/issues/2644>
#[pymodule] // The name of the function must match `lib.name` in `Cargo.toml`
#[cfg_attr(feature = "cython-compat", pyo3(name = "bomber_pyo3"))]
fn _libnautilus(py: Python<'_>, m: &Bound<'_, PyModule>) -> PyResult<()> {
    ...
    let module_name = "bomber.core.bomber_pyo3";

    #[cfg(not(feature = "cython-compat"))]
    let module_name = "bomber._libnautilus";

...
[![crates.io version](https://img.shields.io/crates/v/bomber.svg)](https://crates.io/crates/bomber)
[![Documentation](https://docs.rs/bomber/badge.svg)](https://docs.rs/bomber)

Container crate for [Bomber](https://nautilustrader.io).
...
[Bomber](https://nautilustrader.io) is an open-source, production-grade,
...
See [the Bomber documentation](https://nautilustrader.io/docs) and the

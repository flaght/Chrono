...
#[cfg_attr(
    feature = "python",
    pyo3::pyclass(module = "bomber.core.bomber_pyo3.network", from_py_object)
)]
...
#[cfg_attr(
    ...
    pyo3::pyclass(
        eq,
        eq_int,
        module = "bomber.core.bomber_pyo3.network",
        from_py_object
    )
)]
#[cfg_attr(
    feature = "python",
    pyo3_stub_gen::derive::gen_stub_pyclass_enum(module = "bomber.network")
)]
pub enum HttpMethod {
    GET,
    POST,
...
#[cfg_attr(
    feature = "python",
    pyo3_stub_gen::derive::gen_stub_pyclass(module = "bomber.network")
)]

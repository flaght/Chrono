...
#[pyfunction]
#[pyo3_stub_gen::derive::gen_stub_pyfunction(module = "bomber.adapters.blockchain")]
#[pyo3(name = "load_pool_snapshot")]
#[pyo3(signature = (pg_config, chain_id, pool_address, before_block=None, require_valid=true))]
#[gen_stub(
    override_return_type(
        type_repr = "typing.Optional[bomber.model.PoolSnapshot]",
...
pub fn py_load_pool_snapshot(
    #[gen_stub(
        override_type(
            type_repr = "bomber.infrastructure.PostgresConnectOptions",
            imports = ("bomber.infrastructure",),
        ),
    )]

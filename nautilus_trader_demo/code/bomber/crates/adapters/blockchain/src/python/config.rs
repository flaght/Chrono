...
#[pymethods]
#[pyo3_stub_gen::derive::gen_stub_pymethods(module = "bomber.adapters.blockchain")]
impl DexPoolFilters {
...
impl BlockchainDataClientConfig {
    ...
    fn py_new(
        #[gen_stub(
            override_type(
                type_repr = "bomber.model.Chain",
                imports = ("bomber.model",),
            ),
        )]
        chain: &Chain,
        #[gen_stub(
            override_type(
                type_repr = "typing.Sequence[bomber.model.DexType]",
                imports = ("typing", "bomber.model"),
            ),
        )]
        dex_ids: Vec<DexType>,
        http_rpc_url: String,
        ...
        #[gen_stub(
            override_type(
                type_repr = "typing.Optional[bomber.infrastructure.PostgresConnectOptions]",
                imports = ("typing", "bomber.infrastructure"),
            ),
        )]

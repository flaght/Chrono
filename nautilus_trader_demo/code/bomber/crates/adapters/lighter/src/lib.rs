...
//! [Bomber](https://nautilustrader.io) adapter for the [Lighter](https://lighter.xyz) DEX.
//!
...
//! for the [bomber](https://pypi.org/project/bomber) Python package,
...
//!
//! Submitted create and modify order transactions carry the Bomber integrator account index

...
def test_exec_factory_passes_rust_resolved_account_address(monkeypatch):
    ...
    monkeypatch.setattr(
        "bomber.adapters.hyperliquid.factories.get_cached_hyperliquid_http_client",
        get_http_client,
    )
    monkeypatch.setattr(
        "bomber.adapters.hyperliquid.factories.get_cached_hyperliquid_instrument_provider",
        lambda **_: provider,
    )
    monkeypatch.setattr(
        "bomber.adapters.hyperliquid.factories.HyperliquidExecutionClient",
        create_execution_client,
    )
    monkeypatch.setattr(
        "bomber.adapters.hyperliquid.factories.bomber_pyo3.hyperliquid_resolve_execution_account_address",

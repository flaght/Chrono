...
import bomber.adapters.deribit.data as deribit_data_module
from bomber.adapters.deribit.constants import DERIBIT_VENUE
from bomber.adapters.deribit.data import DeribitVolatilityIndex
...
class TestDeribitDataClient:
    ...
    async def test_subscribe_order_book_deltas(
        ...
        try:
            ...
            # Assert
            expected_id = bomber_pyo3.InstrumentId.from_str("BTC-PERPETUAL.DERIBIT")
    ...
    async def test_handle_msg_custom_data_volatility_index_forwarded(
        ...
        monkeypatch.setattr(
            deribit_data_module.bomber_pyo3,
            "CustomData",
            _FakePyo3CustomData,
        )
    ...
    async def test_request_instrument_receives_single_instrument(
        ...
        try:
            ...
            with patch(
                "bomber.adapters.deribit.data.transform_instrument_from_pyo3",

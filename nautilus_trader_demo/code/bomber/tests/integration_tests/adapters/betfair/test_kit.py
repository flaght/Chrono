...
from bomber.adapters.betfair.data import BetfairParser
from bomber.adapters.betfair.parsing.core import betting_instruments_from_file
from bomber.adapters.betfair.parsing.core import parse_betfair_file
...
from bomber.adapters.betfair.providers import market_definition_to_instruments
            ...
            strategies=(
                [
                    ImportableStrategyConfig(
                        strategy_path="bomber.examples.strategies.orderbook_imbalance:OrderBookImbalance",
                        config_path="bomber.examples.strategies.orderbook_imbalance:OrderBookImbalanceConfig",
                        config={

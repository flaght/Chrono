...
from bomber.adapters.betfair.config import BetfairDataClientConfig
from bomber.adapters.betfair.data import BetfairDataClient
from bomber.adapters.betfair.data_types import BetfairOrderVoided
from bomber.adapters.betfair.data_types import BetfairRaceProgress
from bomber.adapters.betfair.data_types import BetfairRaceRunnerData
...
from bomber.adapters.betfair.factories import BetfairLiveDataClientFactory
...
from bomber.adapters.betfair.providers import BetfairInstrumentProviderConfig
from bomber.adapters.betfair.providers import make_instruments
from bomber.adapters.betfair.providers import parse_market_catalog
...
@patch("bomber.adapters.betfair.providers.load_markets_metadata")
...
async def test_connect(mocker, data_client, instrument):
    # Arrange
    mocker.patch("bomber.adapters.betfair.data.BetfairMarketStreamClient.connect")
    mocker.patch("bomber.adapters.betfair.client.BetfairHttpClient.connect")
    mocker.patch("bomber.adapters.betfair.client.BetfairHttpClient.connect")
...
def test_race_stream_client_created_when_configured(
    ...
    # Arrange
    mocker.patch(
        "bomber.adapters.betfair.factories.get_cached_betfair_client",
        return_value=betfair_client,
    )
    mocker.patch(
        "bomber.adapters.betfair.factories.get_cached_betfair_instrument_provider",

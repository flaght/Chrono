...
from bomber.adapters.betfair.factories import BetfairLiveExecClientFactory
...
def data_client(
    ...
    # Patches
    patch(
        "bomber.adapters.betfair.data.BetfairDataClient._instrument_provider.get_account_currency",
        return_value="GBP",
    )
    mocker.patch(
        "bomber.adapters.betfair.data.BetfairDataClient.stream_subscribe",
    )
    patch(
        "bomber.adapters.betfair.providers.BetfairInstrumentProvider._client.list_navigation",

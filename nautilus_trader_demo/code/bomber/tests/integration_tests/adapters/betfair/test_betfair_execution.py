...
from bomber.adapters.betfair.constants import BETFAIR_PRICE_PRECISION
...
from bomber.adapters.betfair.execution import BetfairExecutionClient
...
from bomber.adapters.betfair.parsing import requests as parsing_requests
...
from bomber.model.instruments.betting import null_handicap
...
def test_duplicate_trade_id_skips_fill(
    ...
    monkeypatch.setattr(
        "bomber.adapters.betfair.execution.order_to_trade_id",
        lambda _uo: trade_id,
    )

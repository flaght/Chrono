...
from bomber.adapters.tardis.common import infer_tardis_exchange_str
from bomber.adapters.tardis.download import download_file
...
def fetch_instruments(
    ...
    if instrument_ids:
        ...
        for instrument_id in instrument_ids:
            ...
            tardis_exchanges.update(bomber_pyo3.tardis_exchange_from_venue_str(venue_str))

...
from bomber.common.actor import ActorConfig
...
from bomber.core.bomber_pyo3.network import http_download
...
class OrderBookActor(Actor):
    ...
    def on_start(self):
        ...
        pyo3_instrument_id = bomber_pyo3.InstrumentId.from_str(self.instrument.id.value)
        self.order_book = bomber_pyo3.OrderBook(pyo3_instrument_id, book_type)
    ...
    def on_order_book_deltas(self, order_book_deltas: bomber_pyo3.OrderBookDeltas):

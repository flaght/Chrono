...
from bomber.test_kit.stubs.commands import TestCommandStubs
from bomber.test_kit.stubs.events import TestEventStubs
from bomber.test_kit.stubs.execution import TestExecStubs
...
def exec_client_builder_spot(
    ...
    def builder(monkeypatch, *, config_kwargs: dict | None = None):
        ...
        monkeypatch.setattr(
            "bomber.adapters.kraken.execution.bomber_pyo3.KrakenSpotWebSocketClient",
            lambda *args, **kwargs: ws_spot_client,
        )

        # Skip account registration wait in tests
        monkeypatch.setattr(
            "bomber.adapters.kraken.execution.KrakenExecutionClient._await_account_registered",
            AsyncMock(),
        )
        ...
        config = KrakenExecClientConfig(
            ...
            product_types=(bomber_pyo3.KrakenProductType.SPOT,),
            **(config_kwargs or {}),
        )
...
def exec_client_builder_futures(
    ...
    def builder(monkeypatch, *, config_kwargs: dict | None = None):
        ...
        monkeypatch.setattr(
            "bomber.adapters.kraken.execution.bomber_pyo3.KrakenFuturesWebSocketClient",
        ...
        config = KrakenExecClientConfig(
            api_key="test_api_key",
            api_secret="test_api_secret",
            product_types=(bomber_pyo3.KrakenProductType.FUTURES,),
            **(config_kwargs or {}),
        )
...
def exec_client_builder_dual(
    ...
    def builder(monkeypatch, *, config_kwargs: dict | None = None):
        ...
        config = KrakenExecClientConfig(
            ...
            api_secret="test_api_secret",
            product_types=(
                bomber_pyo3.KrakenProductType.SPOT,
                bomber_pyo3.KrakenProductType.FUTURES,
            ),
            **(config_kwargs or {}),
        )
...
async def test_submit_stop_market_order_spot_passes_trigger_type(
    ...
    try:
        ...
        assert call_kwargs["order_type"] == bomber_pyo3.OrderType.STOP_MARKET
        assert call_kwargs["trigger_type"] == bomber_pyo3.TriggerType.INDEX_PRICE
...
async def test_submit_trailing_stop_limit_order_spot_passes_offsets(
    ...
    try:
        ...
        http_client.submit_order.assert_awaited_once()
        call_kwargs = http_client.submit_order.call_args.kwargs
        assert call_kwargs["order_type"] == bomber_pyo3.OrderType.TRAILING_STOP_LIMIT
        assert call_kwargs["trigger_type"] == bomber_pyo3.TriggerType.LAST_PRICE
...
async def test_submit_stop_market_order_futures_passes_trigger_type(
    ...
    try:
        ...
        call_kwargs = http_client.submit_order.call_args.kwargs
        assert call_kwargs["order_type"] == bomber_pyo3.OrderType.STOP_MARKET
        assert call_kwargs["trigger_type"] == bomber_pyo3.TriggerType.MARK_PRICE
        assert str(call_kwargs["trigger_price"]) == "49000.0"
    finally:
        await client._disconnect()
...
async def test_generate_order_status_reports_converts_results_spot(
    ...
    monkeypatch.setattr(
        "bomber.adapters.kraken.execution.OrderStatusReport.from_pyo3",
...
async def test_generate_fill_reports_converts_results_spot(
    ...
    expected_report = MagicMock()
    monkeypatch.setattr(
        "bomber.adapters.kraken.execution.FillReport.from_pyo3",
        lambda obj: expected_report,
    )
...
async def test_generate_position_status_reports_converts_results_spot(
    ...
    expected_report = MagicMock()
    monkeypatch.setattr(
        "bomber.adapters.kraken.execution.PositionStatusReport.from_pyo3",
        lambda obj: expected_report,
    )
...
async def test_handle_order_status_report_accepted(
    ...
    pyo3_report = bomber_pyo3.OrderStatusReport(
        account_id=bomber_pyo3.AccountId("KRAKEN-UNIFIED"),
        instrument_id=bomber_pyo3.InstrumentId.from_str(instrument.id.value),
        venue_order_id=bomber_pyo3.VenueOrderId("KRAKEN-789"),
        client_order_id=bomber_pyo3.ClientOrderId("O-123456"),
        order_side=bomber_pyo3.OrderSide.BUY,
        order_type=bomber_pyo3.OrderType.LIMIT,
        time_in_force=bomber_pyo3.TimeInForce.GTC,
        order_status=bomber_pyo3.OrderStatus.ACCEPTED,
        quantity=bomber_pyo3.Quantity.from_str("0.100"),
        filled_qty=bomber_pyo3.Quantity.from_str("0"),
        ts_accepted=0,
        ts_last=0,
...
async def test_handle_order_status_report_canceled(
    ...
    pyo3_report = bomber_pyo3.OrderStatusReport(
        ...
        order_type=bomber_pyo3.OrderType.LIMIT,
        time_in_force=bomber_pyo3.TimeInForce.GTC,
        order_status=bomber_pyo3.OrderStatus.CANCELED,
        quantity=bomber_pyo3.Quantity.from_str("0.100"),
        filled_qty=bomber_pyo3.Quantity.from_str("0"),
        ts_accepted=0,
        ts_last=0,
...
async def test_handle_order_status_report_expired(
    ...
    pyo3_report = bomber_pyo3.OrderStatusReport(
        ...
        order_side=bomber_pyo3.OrderSide.BUY,
        order_type=bomber_pyo3.OrderType.LIMIT,
        time_in_force=bomber_pyo3.TimeInForce.GTD,
        order_status=bomber_pyo3.OrderStatus.EXPIRED,
        quantity=bomber_pyo3.Quantity.from_str("0.100"),
        filled_qty=bomber_pyo3.Quantity.from_str("0"),
        ts_accepted=0,
        ts_last=0,
...
async def test_handle_order_status_report_rejected(
    ...
    pyo3_report = bomber_pyo3.OrderStatusReport(
        ...
        order_type=bomber_pyo3.OrderType.LIMIT,
        time_in_force=bomber_pyo3.TimeInForce.GTC,
        order_status=bomber_pyo3.OrderStatus.REJECTED,
        quantity=bomber_pyo3.Quantity.from_str("0.100"),
        filled_qty=bomber_pyo3.Quantity.from_str("0"),
        ts_accepted=0,
        ts_last=0,
...
async def test_handle_fill_report_pyo3(
    ...
    fill_report = bomber_pyo3.FillReport(
        ...
        last_px=bomber_pyo3.Price.from_str("50000.0"),
        commission=bomber_pyo3.Money.from_str("0.10 USDT"),
...
async def test_handle_account_state_pyo3(
    ...
    account_state = bomber_pyo3.AccountState(
        account_id=bomber_pyo3.AccountId("KRAKEN-UNIFIED"),
        account_type=bomber_pyo3.AccountType.CASH,
        base_currency=None,
        balances=[
            bomber_pyo3.AccountBalance(
                total=bomber_pyo3.Money.from_str("100000 USDT"),
                locked=bomber_pyo3.Money.from_str("0 USDT"),
                free=bomber_pyo3.Money.from_str("100000 USDT"),
            ),
        ],
        margins=[],
        is_reported=True,
...
async def test_handle_order_cancel_rejected_pyo3_conversion(
    ...
    pyo3_event = bomber_pyo3.OrderCancelRejected(
        ...
        instrument_id=bomber_pyo3.InstrumentId.from_str(instrument.id.value),
        client_order_id=bomber_pyo3.ClientOrderId("O-123456"),
        venue_order_id=bomber_pyo3.VenueOrderId("KRAKEN-12345"),
...
async def test_external_order_fill_report_sent_directly(
    ...
    fill_report = bomber_pyo3.FillReport(
        account_id=bomber_pyo3.AccountId("KRAKEN-UNIFIED"),
        instrument_id=bomber_pyo3.InstrumentId.from_str(instrument.id.value),
        venue_order_id=bomber_pyo3.VenueOrderId("KRAKEN-EXTERNAL-789"),
        trade_id=bomber_pyo3.TradeId("T-EXT-001"),
        order_side=bomber_pyo3.OrderSide.BUY,
        last_qty=bomber_pyo3.Quantity.from_str("0.100"),
        last_px=bomber_pyo3.Price.from_str("50000.0"),
        commission=bomber_pyo3.Money.from_str("0.10 USDT"),
        liquidity_side=bomber_pyo3.LiquiditySide.TAKER,
        ts_event=0,
        client_order_id=bomber_pyo3.ClientOrderId("EXTERNAL-ORDER"),
        report_id=bomber_pyo3.UUID4(),
        ts_init=0,
    )
...
async def test_generate_order_status_report_futures_fill_fallback_queries_futures_client_only(
    ...
    http_client_futures.request_fill_reports.return_value = [
        bomber_pyo3.FillReport(
            account_id=bomber_pyo3.AccountId("KRAKEN-UNIFIED"),
            instrument_id=bomber_pyo3.InstrumentId.from_str(futures_instrument.id.value),
            venue_order_id=bomber_pyo3.VenueOrderId(venue_order_id.value),
            trade_id=bomber_pyo3.TradeId("T-000"),
            order_side=bomber_pyo3.OrderSide.BUY,
            last_qty=bomber_pyo3.Quantity.from_str("100"),
            last_px=bomber_pyo3.Price.from_str("50000.0"),
            commission=bomber_pyo3.Money.from_str("0 USD"),
            liquidity_side=bomber_pyo3.LiquiditySide.TAKER,
            ts_event=1,
...
async def test_generate_order_status_report_futures_falls_back_to_matched_fills(
    ...
    http_client.request_fill_reports.return_value = [
        bomber_pyo3.FillReport(
            ...
            trade_id=bomber_pyo3.TradeId("T-001"),
            order_side=bomber_pyo3.OrderSide.BUY,
            last_qty=bomber_pyo3.Quantity.from_str("40"),
            last_px=bomber_pyo3.Price.from_str("50000.0"),
            commission=bomber_pyo3.Money.from_str("0 USD"),
            liquidity_side=bomber_pyo3.LiquiditySide.TAKER,
            ts_event=1,
        ...
        bomber_pyo3.FillReport(
            ...
            order_side=bomber_pyo3.OrderSide.BUY,
            last_qty=bomber_pyo3.Quantity.from_str("60"),
            last_px=bomber_pyo3.Price.from_str("50010.0"),
            commission=bomber_pyo3.Money.from_str("0 USD"),
            liquidity_side=bomber_pyo3.LiquiditySide.TAKER,
            ts_event=2,
            client_order_id=bomber_pyo3.ClientOrderId(order.client_order_id.value),
        ...
        bomber_pyo3.FillReport(
            account_id=bomber_pyo3.AccountId("KRAKEN-UNIFIED"),
            instrument_id=bomber_pyo3.InstrumentId.from_str(futures_instrument.id.value),
            venue_order_id=bomber_pyo3.VenueOrderId("KRAKEN-OTHER"),
            trade_id=bomber_pyo3.TradeId("T-OTHER"),
            order_side=bomber_pyo3.OrderSide.BUY,
            last_qty=bomber_pyo3.Quantity.from_str("999"),
            last_px=bomber_pyo3.Price.from_str("1.0"),
            commission=bomber_pyo3.Money.from_str("0 USD"),
            liquidity_side=bomber_pyo3.LiquiditySide.TAKER,
            ts_event=3,
            client_order_id=bomber_pyo3.ClientOrderId(order.client_order_id.value),
...
async def test_generate_order_status_report_futures_fill_fallback_requires_full_size(
    ...
    http_client.request_fill_reports.return_value = [
        bomber_pyo3.FillReport(
            ...
            instrument_id=bomber_pyo3.InstrumentId.from_str(futures_instrument.id.value),
            venue_order_id=bomber_pyo3.VenueOrderId(venue_order_id.value),
            trade_id=bomber_pyo3.TradeId("T-003"),
            order_side=bomber_pyo3.OrderSide.BUY,
            last_qty=bomber_pyo3.Quantity.from_str("40"),
            last_px=bomber_pyo3.Price.from_str("50000.0"),
            commission=bomber_pyo3.Money.from_str("0 USD"),
...
async def test_generate_order_status_report_futures_fill_fallback_matches_truncated_client_order_id(
    ...
    http_client.request_fill_reports.return_value = [
        bomber_pyo3.FillReport(
            account_id=bomber_pyo3.AccountId("KRAKEN-UNIFIED"),
            instrument_id=bomber_pyo3.InstrumentId.from_str(futures_instrument.id.value),
            venue_order_id=bomber_pyo3.VenueOrderId("KRAKEN-791"),
            trade_id=bomber_pyo3.TradeId("T-004"),
            order_side=bomber_pyo3.OrderSide.BUY,
            last_qty=bomber_pyo3.Quantity.from_str("100"),
            last_px=bomber_pyo3.Price.from_str("50000.0"),
            commission=bomber_pyo3.Money.from_str("0 USD"),
            liquidity_side=bomber_pyo3.LiquiditySide.TAKER,
            ts_event=1,
            client_order_id=bomber_pyo3.ClientOrderId(
...
def _make_pyo3_batch_order(
    ...
    return (
        bomber_pyo3.InstrumentId.from_str("XBT/USDT.KRAKEN"),
        bomber_pyo3.ClientOrderId(client_order_id),
        bomber_pyo3.OrderSide.BUY,
        bomber_pyo3.OrderType.LIMIT,
        bomber_pyo3.Quantity.from_str("0.10000000"),
        bomber_pyo3.TimeInForce.GTC,
        bomber_pyo3.Price.from_str("50000.0"),
        None,
        None,
        False,
        False,
...
async def test_submit_orders_batch_rejects_short_per_order_reduce_only() -> None:
    ...
    """
    http_client = bomber_pyo3.KrakenSpotHttpClient()
    orders = [

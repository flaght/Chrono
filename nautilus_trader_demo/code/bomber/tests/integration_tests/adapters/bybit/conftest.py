...
def mock_http_client():
    mock = MagicMock(spec=bomber_pyo3.BybitHttpClient)
...
def _create_ws_mock() -> MagicMock:
    mock = MagicMock(spec=bomber_pyo3.BybitWebSocketClient)
...
def mock_instrument_provider(instrument):
    ...
    provider.product_types = (bomber_pyo3.BybitProductType.SPOT,)
    provider._product_types = (bomber_pyo3.BybitProductType.SPOT,)
    return provider

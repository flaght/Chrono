...
def data_client_builder(
    ...
    def builder(monkeypatch, *, config_kwargs: dict | None = None):
        ...
        monkeypatch.setattr(
            "bomber.adapters.bybit.data.bomber_pyo3.BybitWebSocketClient.new_public",
        ...
        config = BybitDataClientConfig(
            ...
            product_types=(bomber_pyo3.BybitProductType.SPOT,),
            **(config_kwargs or {}),
        )
...
async def test_subscribe_order_book_deltas(data_client_builder, monkeypatch):
    ...
    try:
        ...
        # Assert
        expected_id = bomber_pyo3.InstrumentId.from_str("BTCUSDT-SPOT.BYBIT")

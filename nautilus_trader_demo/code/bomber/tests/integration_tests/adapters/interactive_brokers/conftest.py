...
@pytest.fixture
@patch(
    "bomber.adapters.interactive_brokers.factories.get_cached_ib_client",
    new=mocked_ib_client,
)
@patch(
    "bomber.adapters.interactive_brokers.factories.get_cached_interactive_brokers_instrument_provider",

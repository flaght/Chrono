...
from bomber.test_kit.rust.data_pyo3 import TestDataProviderPyo3


ES_ID = bomber_pyo3.InstrumentId.from_str("ESZ21.GLBX")
NQ_ID = bomber_pyo3.InstrumentId.from_str("NQZ21.GLBX")
GLBX = Venue("GLBX")
...
async def test_request_bars_multi_bar_type_single_response(
    ...
    es_bar_type = bomber_pyo3.BarType(
        ES_ID,
        bomber_pyo3.BarSpecification(
            1,
            bomber_pyo3.BarAggregation("MINUTE"),
            bomber_pyo3.PriceType("LAST"),
        ),
    )
    nq_bar_type = bomber_pyo3.BarType(
        NQ_ID,
        bomber_pyo3.BarSpecification(
            1,
            bomber_pyo3.BarAggregation("MINUTE"),
    ...
    pyo3_bars = [
        bomber_pyo3.Bar(
            bar_type=es_bar_type,
            open=bomber_pyo3.Price.from_str("4500.00"),
            high=bomber_pyo3.Price.from_str("4510.00"),
            low=bomber_pyo3.Price.from_str("4490.00"),
            close=bomber_pyo3.Price.from_str("4505.00"),
            volume=bomber_pyo3.Quantity.from_int(100),
            ts_event=0,
            ts_init=0,
        ),
        bomber_pyo3.Bar(
            bar_type=es_bar_type,
            open=bomber_pyo3.Price.from_str("4505.00"),
            high=bomber_pyo3.Price.from_str("4515.00"),
            low=bomber_pyo3.Price.from_str("4495.00"),
            close=bomber_pyo3.Price.from_str("4510.00"),
            volume=bomber_pyo3.Quantity.from_int(80),
            ts_event=1,
            ts_init=1,
        ),
        bomber_pyo3.Bar(
            bar_type=nq_bar_type,
            open=bomber_pyo3.Price.from_str("15500.00"),
            high=bomber_pyo3.Price.from_str("15510.00"),
            low=bomber_pyo3.Price.from_str("15490.00"),
            close=bomber_pyo3.Price.from_str("15505.00"),
            volume=bomber_pyo3.Quantity.from_int(50),
            ts_event=0,
            ts_init=0,
        ),
    ]

...
from bomber.adapters.polymarket.fee_model import PolymarketFeeModelConfig
from bomber.adapters.polymarket.fee_model import calculate_maker_rebate
from bomber.adapters.polymarket.fee_model import infer_maker_rebate_rate
...
def test_factory_path_constructs_via_importable_config():
    ...
    cfg = ImportableFeeModelConfig(
        fee_model_path="bomber.adapters.polymarket.fee_model:PolymarketFeeModel",
        config_path=("bomber.adapters.polymarket.fee_model:PolymarketFeeModelConfig"),

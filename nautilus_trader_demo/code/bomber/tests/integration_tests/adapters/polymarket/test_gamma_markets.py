...
from bomber.adapters.polymarket.common.gamma_markets import iter_markets
...
def test_normalize_gamma_market_uses_full_timestamps_for_updown_market() -> None:
    ...
    Regression test for
    https://github.com/nautechsystems/bomber/issues/4278.
...
_LIST_MARKETS = "bomber.adapters.polymarket.common.gamma_markets.list_markets"
...
_REQUEST_MARKETS_PAGE = (
    "bomber.adapters.polymarket.common.gamma_markets._request_markets_page"
)

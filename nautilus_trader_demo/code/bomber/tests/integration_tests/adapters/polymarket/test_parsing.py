...
from bomber.adapters.polymarket.common.enums import PolymarketLiquiditySide
from bomber.adapters.polymarket.common.enums import PolymarketOrderSide
from bomber.adapters.polymarket.common.enums import PolymarketOrderStatus
from bomber.adapters.polymarket.common.enums import PolymarketOrderType
from bomber.adapters.polymarket.common.enums import PolymarketSignatureType
from bomber.adapters.polymarket.common.enums import PolymarketTradeStatus
from bomber.adapters.polymarket.common.parsing import basis_points_as_decimal
from bomber.adapters.polymarket.common.parsing import calculate_commission
from bomber.adapters.polymarket.common.parsing import determine_order_side
from bomber.adapters.polymarket.common.parsing import determine_trade_id
from bomber.adapters.polymarket.common.parsing import extract_fee_rates
from bomber.adapters.polymarket.common.parsing import parse_polymarket_instrument
from bomber.adapters.polymarket.schemas.book import PolymarketBookLevel
from bomber.adapters.polymarket.schemas.book import PolymarketBookSnapshot
from bomber.adapters.polymarket.schemas.book import PolymarketQuote
from bomber.adapters.polymarket.schemas.book import PolymarketQuotes
from bomber.adapters.polymarket.schemas.book import PolymarketTickSizeChange
from bomber.adapters.polymarket.schemas.book import PolymarketTrade
from bomber.adapters.polymarket.schemas.order import PolymarketMakerOrder
...
from bomber.model.currencies import USDC
...
def test_parse_to_quote_ticks_uses_best_bid_ask_not_changed_level() -> None:
    """
    Regression test for https://github.com/nautechsystems/bomber/issues/3905.
...
def test_parse_user_trade_to_fill_report_ts_event() -> None:
    ...
    Regression test for
    https://github.com/nautechsystems/bomber/issues/3273
...
def test_trade_report_get_asset_id_maker_returns_maker_order_asset_id() -> None:
    ...
    Regression test for
    https://github.com/nautechsystems/bomber/issues/3345
...
def test_determine_order_side(
    ...
    Regression test for
    https://github.com/nautechsystems/bomber/issues/3357

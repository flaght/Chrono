...
def mock_http_client():
    mock = MagicMock(spec=bomber_pyo3.AxHttpClient)
...
def _create_ws_mock() -> MagicMock:
    ...
    """
    mock = MagicMock(spec=bomber_pyo3.AxMdWebSocketClient)
...
def _create_orders_ws_mock() -> MagicMock:
    ...
    """
    mock = MagicMock(spec=bomber_pyo3.AxOrdersWebSocketClient)

...
from bomber.adapters.bitmex.execution import BitmexExecutionClient
...
def mock_http_client():
    ...
    """
    mock = MagicMock(spec=bomber_pyo3.BitmexHttpClient)
...
def mock_ws_client():
    ...
    """
    mock = MagicMock(spec=bomber_pyo3.BitmexWebSocketClient)
...
def mock_submitter():
    ...
    """
    mock = MagicMock(spec=bomber_pyo3.SubmitBroadcaster)
...
def mock_canceller():
    ...
    """
    mock = MagicMock(spec=bomber_pyo3.CancelBroadcaster)
...
def exec_client(
    ...
    monkeypatch.setattr(
        "bomber.adapters.bitmex.execution.bomber_pyo3.BitmexWebSocketClient",
        lambda *args, **kwargs: mock_ws_client,
    )

    # Patch the SubmitBroadcaster creation
    monkeypatch.setattr(
        "bomber.adapters.bitmex.execution.bomber_pyo3.SubmitBroadcaster",
        lambda *args, **kwargs: mock_submitter,
    )

    # Patch the CancelBroadcaster creation
    monkeypatch.setattr(
        "bomber.adapters.bitmex.execution.bomber_pyo3.CancelBroadcaster",
    ...
    config = BitmexExecClientConfig(
        ...
        environment=bomber_pyo3.BitmexEnvironment.TESTNET,
    )

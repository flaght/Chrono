...
async def main():
    ...
    http_client = bomber_pyo3.OKXHttpClient.from_env()

    # Instrument type must match the product type you want to query
    okx_account_id = bomber_pyo3.AccountId("OKX-master")
    okx_instrument_type = bomber_pyo3.OKXInstrumentType.MARGIN
    ...
    if instruments:
        ...
        if okx_instrument_type == bomber_pyo3.OKXInstrumentType.MARGIN:

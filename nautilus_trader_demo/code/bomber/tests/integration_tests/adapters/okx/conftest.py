...
def mock_http_client():
    mock = MagicMock(spec=bomber_pyo3.OKXHttpClient)
...
def _create_ws_mock() -> MagicMock:
    mock = MagicMock(spec=bomber_pyo3.OKXWebSocketClient)
...
def mock_instrument_provider(instrument):
    ...
    provider.instrument_types = (bomber_pyo3.OKXInstrumentType.SPOT,)
    provider._instrument_types = (bomber_pyo3.OKXInstrumentType.SPOT,)
    return provider

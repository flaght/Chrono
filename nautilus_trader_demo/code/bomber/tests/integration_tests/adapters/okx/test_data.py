...
from bomber.adapters.okx.data import OKXDataClient
from bomber.adapters.okx.data import _is_instrument_definition_error
...
def data_client_builder(
    ...
    def builder(monkeypatch, *, config_kwargs: dict | None = None):
        ...
        monkeypatch.setattr(
            "bomber.adapters.okx.data.bomber_pyo3.OKXWebSocketClient",
        ...
        config = OKXDataClientConfig(
            ...
            instrument_types=(bomber_pyo3.OKXInstrumentType.SPOT,),
...
async def test_subscribe_order_book_deltas_depth_default_uses_standard_channel(
    ...
    try:
        ...
        public_ws.vip_level = bomber_pyo3.OKXVipLevel.VIP0
...
async def test_subscribe_order_book_deltas_depth_50_requires_vip(data_client_builder, monkeypatch):
    ...
    try:
        public_ws.subscribe_book_with_depth.reset_mock()
        public_ws.vip_level = bomber_pyo3.OKXVipLevel.VIP3
...
async def test_subscribe_order_book_deltas_depth_50_with_vip_calls_compact(
    ...
    try:
        public_ws.subscribe_book_with_depth.reset_mock()
        public_ws.vip_level = bomber_pyo3.OKXVipLevel.VIP4
...
async def test_subscribe_bars_uses_business_websocket(data_client_builder, monkeypatch):
    ...
    try:
        ...
        monkeypatch.setattr(
            "bomber.adapters.okx.data.bomber_pyo3.BarType.from_str",
            fake_from_str,
        )
...
async def test_request_instrument_receives_single_instrument(
    ...
    try:
        ...
        with patch(
            "bomber.adapters.okx.data.transform_instrument_from_pyo3",
...
@pytest.mark.parametrize(
    "convention",
    [
        bomber_pyo3.GreeksConvention.BLACK_SCHOLES,
...
async def test_handle_msg_option_greeks_forwarded_when_subscribed(
    ...
    try:
        ...
        pyo3_greeks = MagicMock(spec=bomber_pyo3.OptionGreeks)

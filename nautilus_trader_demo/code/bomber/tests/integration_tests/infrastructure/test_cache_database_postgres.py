...
from bomber.cache.adapter import CachePostgresAdapter
...
class TestCachePostgresAdapter:
    ...
    async def test_add_order_snapshot(self):
        ...
        assert isinstance(snapshot1, bomber_pyo3.OrderSnapshot)
        assert isinstance(snapshot2, bomber_pyo3.OrderSnapshot)
        assert isinstance(snapshot3, bomber_pyo3.OrderSnapshot)
    ...
    async def test_add_position_snapshot(self):
        ...
        assert isinstance(snapshot, bomber_pyo3.PositionSnapshot)

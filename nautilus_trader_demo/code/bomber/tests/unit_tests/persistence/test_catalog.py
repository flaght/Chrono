...
from bomber.persistence.funcs import class_to_filename
...
from bomber.test_kit.mocks.data import NewsEventData
...
from bomber.test_kit.stubs.persistence import TestPersistenceStubs
...
def test_query_rust_drops_capsule_chunks(catalog: ParquetDataCatalog) -> None:
    ...
    https://github.com/nautechsystems/bomber/issues/3889

    """
    from bomber.persistence.catalog import parquet as parquet_module

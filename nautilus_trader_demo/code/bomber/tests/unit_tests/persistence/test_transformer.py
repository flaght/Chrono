...
def test_pyo3_quotes_to_record_batch_reader() -> None:
    ...
    # Act
    batch_bytes = bomber_pyo3.quotes_to_arrow_record_batch_bytes(quotes)
...
def test_legacy_trades_to_record_batch_reader() -> None:
    ...
    # Act
    batch_bytes = bomber_pyo3.pyobjects_to_arrow_record_batch_bytes(trades)
    reader = pa.ipc.open_stream(BytesIO(batch_bytes))
...
def test_legacy_deltas_to_record_batch_reader() -> None:
    ...
    # Act
    batch_bytes = bomber_pyo3.pyobjects_to_arrow_record_batch_bytes(deltas)
    reader = pa.ipc.open_stream(BytesIO(batch_bytes))
...
def test_get_schema_map_with_unsupported_type() -> None:
    ...
    with pytest.raises(TypeError):
        bomber_pyo3.get_arrow_schema_map(str)
...
def test_get_schema_map_for_all_implemented_types(
    ...
    # Arrange, Act
    schema_map = bomber_pyo3.get_arrow_schema_map(data_type)

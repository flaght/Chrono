...
from bomber.execution.messages import TradingCommand
...
from bomber.test_kit.mocks.exec_clients import MockExecutionClient
...
class TestExecutionEngine:
    ...
    def test_submit_order_adds_to_own_book_bid(self) -> None:
        ...
        assert own_order.status == bomber_pyo3.OrderStatus.INITIALIZED
    ...
    def test_order_updates_in_own_book(self) -> None:
        ...
        assert own_order_bid.status == bomber_pyo3.OrderStatus.ACCEPTED
        ...
        assert own_order_ask.status == bomber_pyo3.OrderStatus.ACCEPTED

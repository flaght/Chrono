...
class TestExecutionReports:
    def test_order_status_report_to_pyo3_with_trailing_offset_type_none(self):
        ...
        assert (
            pyo3_report.trailing_offset_type == bomber_pyo3.TrailingOffsetType.NO_TRAILING_OFFSET
        )
        assert pyo3_report.account_id.value == "SIM-001"
        assert pyo3_report.venue_order_id.value == "TEST-001"
        assert pyo3_report.order_side == bomber_pyo3.OrderSide.BUY
    ...
    def test_order_status_report_to_pyo3_with_trailing_offset_type_set(self):
        ...
        # Assert
        assert pyo3_report.trailing_offset_type == bomber_pyo3.TrailingOffsetType.PRICE
    ...
    def test_execution_mass_status_to_pyo3_with_non_trailing_order(self):
        ...
        assert (
            ...
            == bomber_pyo3.TrailingOffsetType.NO_TRAILING_OFFSET
        )
    ...
    def test_instantiate_fill_report(self):
        ...
        assert (
            str(report)
            == f"FillReport(account_id=SIM-001, instrument_id=AUD/USD.IDEALPRO, client_order_id=O-123456789, venue_order_id=1, venue_position_id=2, trade_id=3, order_side=BUY, last_qty=10_000_000, last_px=100.50, commission=4.50 USD, liquidity_side=TAKER, avg_px=None, report_id={report_id}, ts_event=0, ts_init=0)"
        )
        assert (
            repr(report)
            == f"FillReport(account_id=SIM-001, instrument_id=AUD/USD.IDEALPRO, client_order_id=O-123456789, venue_order_id=1, venue_position_id=2, trade_id=3, order_side=BUY, last_qty=10_000_000, last_px=100.50, commission=4.50 USD, liquidity_side=TAKER, avg_px=None, report_id={report_id}, ts_event=0, ts_init=0)"
    ...
    def test_order_status_report_from_pyo3_with_all_fields(self):
        ...
        pyo3_report = bomber_pyo3.OrderStatusReport(
            account_id=bomber_pyo3.AccountId("SIM-001"),
            instrument_id=bomber_pyo3.InstrumentId.from_str("AUD/USD.IDEALPRO"),
            venue_order_id=bomber_pyo3.VenueOrderId("V123"),
            order_side=bomber_pyo3.OrderSide.BUY,
            order_type=bomber_pyo3.OrderType.STOP_LIMIT,
            time_in_force=bomber_pyo3.TimeInForce.GTD,
            order_status=bomber_pyo3.OrderStatus.TRIGGERED,
            quantity=bomber_pyo3.Quantity.from_str("100000"),
            filled_qty=bomber_pyo3.Quantity.from_str("50000"),
            ...
            order_list_id=bomber_pyo3.OrderListId("OL-001"),
            venue_position_id=bomber_pyo3.PositionId("P-001"),
            contingency_type=bomber_pyo3.ContingencyType.OCO,
            expire_time=4_000_000_000,
            price=bomber_pyo3.Price.from_str("1.00050"),
            trigger_price=bomber_pyo3.Price.from_str("1.00100"),
            trigger_type=bomber_pyo3.TriggerType.BID_ASK,
            limit_offset=Decimal("0.00010"),
            trailing_offset=Decimal("0.00020"),
            trailing_offset_type=bomber_pyo3.TrailingOffsetType.BASIS_POINTS,
            avg_px=Decimal("1.00055"),
            display_qty=bomber_pyo3.Quantity.from_str("25000"),
            post_only=True,
            reduce_only=True,
    ...
    def test_order_status_report_from_pyo3_with_minimal_fields(self):
        ...
        pyo3_report = bomber_pyo3.OrderStatusReport(
            account_id=bomber_pyo3.AccountId("SIM-001"),
            instrument_id=bomber_pyo3.InstrumentId.from_str("AUD/USD.IDEALPRO"),
            venue_order_id=bomber_pyo3.VenueOrderId("V456"),
            order_side=bomber_pyo3.OrderSide.SELL,
            order_type=bomber_pyo3.OrderType.MARKET,
            time_in_force=bomber_pyo3.TimeInForce.IOC,
            order_status=bomber_pyo3.OrderStatus.FILLED,
            quantity=bomber_pyo3.Quantity.from_str("50000"),
            filled_qty=bomber_pyo3.Quantity.from_str("50000"),
            ts_accepted=1_000_000_000,
            ts_last=2_000_000_000,
            ts_init=3_000_000_000,
    ...
    def test_fill_report_from_pyo3_with_all_fields(self):
        ...
        pyo3_report = bomber_pyo3.FillReport(
            account_id=bomber_pyo3.AccountId("SIM-001"),
            instrument_id=bomber_pyo3.InstrumentId.from_str("AUD/USD.IDEALPRO"),
            venue_order_id=bomber_pyo3.VenueOrderId("V789"),
            trade_id=bomber_pyo3.TradeId("T123"),
            order_side=bomber_pyo3.OrderSide.BUY,
            last_qty=bomber_pyo3.Quantity.from_str("10000"),
            last_px=bomber_pyo3.Price.from_str("1.00055"),
            commission=bomber_pyo3.Money.from_str("2.50 USD"),
            liquidity_side=bomber_pyo3.LiquiditySide.MAKER,
            ts_event=1_000_000_000,
            ts_init=2_000_000_000,
            client_order_id=bomber_pyo3.ClientOrderId("O-789456"),
            venue_position_id=bomber_pyo3.PositionId("P-002"),
            report_id=bomber_pyo3.UUID4(),
        )
    ...
    def test_fill_report_from_pyo3_without_venue_position_id(self):
        ...
        pyo3_report = bomber_pyo3.FillReport(
            account_id=bomber_pyo3.AccountId("SIM-001"),
            instrument_id=bomber_pyo3.InstrumentId.from_str("AUD/USD.IDEALPRO"),
            venue_order_id=bomber_pyo3.VenueOrderId("V999"),
            trade_id=bomber_pyo3.TradeId("T999"),
            order_side=bomber_pyo3.OrderSide.SELL,
            last_qty=bomber_pyo3.Quantity.from_str("5000"),
            last_px=bomber_pyo3.Price.from_str("1.00045"),
            commission=bomber_pyo3.Money.from_str("1.25 USD"),
    ...
    def test_position_status_report_from_pyo3(self):
        ...
        pyo3_report = bomber_pyo3.PositionStatusReport(
            account_id=bomber_pyo3.AccountId("SIM-001"),
            instrument_id=bomber_pyo3.InstrumentId.from_str("AUD/USD.IDEALPRO"),
            position_side=bomber_pyo3.PositionSide.LONG,
            quantity=bomber_pyo3.Quantity.from_str("100000"),
            venue_position_id=bomber_pyo3.PositionId("P-003"),
    ...
    def test_position_status_report_from_pyo3_short_position(self):
        ...
        pyo3_report = bomber_pyo3.PositionStatusReport(
            account_id=bomber_pyo3.AccountId("SIM-001"),
            instrument_id=bomber_pyo3.InstrumentId.from_str("AUD/USD.IDEALPRO"),
            position_side=bomber_pyo3.PositionSide.SHORT,
            quantity=bomber_pyo3.Quantity.from_str("50000"),
            ts_last=1_000_000_000,
            ts_init=2_000_000_000,
        )
    ...
    def test_position_status_report_avg_px_open_from_pyo3(self):
        ...
        pyo3_report = bomber_pyo3.PositionStatusReport(
            ...
            quantity=bomber_pyo3.Quantity.from_str("100000"),
            venue_position_id=bomber_pyo3.PositionId("P-003"),
            avg_px_open=bomber_pyo3.Price.from_str("1.35000"),
            ts_last=1_000_000_000,
            ts_init=2_000_000_000,
        )

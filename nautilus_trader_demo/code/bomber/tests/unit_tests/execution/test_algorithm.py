...
from bomber.common.component import TimeEventHandler
from bomber.config import DataEngineConfig
from bomber.config import ExecEngineConfig
from bomber.config import ImportableExecAlgorithmConfig
...
class TestExecAlgorithm:
    ...
    def test_exec_algorithm_to_importable_config(self) -> None:
        ...
        assert config.dict() == {
            "exec_algorithm_path": "bomber.examples.algorithms.twap:TWAPExecAlgorithm",
            "config_path": "bomber.examples.algorithms.twap:TWAPExecAlgorithmConfig",
            "config": {

...
class TestCache:
    ...
    def test_update_own_order_book_with_market_order_does_not_raise(self):
        ...
        # Previously this raised: TypeError: Cannot initialize MARKET order as `bomber_pyo3.OwnBookOrder`, no price
    ...
    def test_own_order_book_when_order_book_exists_returns_expected(self):
        # Arrange
        instrument = ETHUSDT_BINANCE
        pyo3_instrument_id = bomber_pyo3.InstrumentId.from_str(instrument.id.value)
        pyo3_own_order_book = bomber_pyo3.OwnOrderBook(pyo3_instrument_id)

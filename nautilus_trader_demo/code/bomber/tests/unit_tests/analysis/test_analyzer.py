...
from bomber.analysis import BetaRatio
from bomber.analysis import CalmarRatio
from bomber.analysis import InformationRatio
...
from bomber.analysis.analyzer import _is_pyo3_statistic
...
class _RecordingPyo3Statistic:
    __module__ = "bomber.core.bomber_pyo3"
...
class _FakePyo3SubmoduleStatistic:
    __module__ = "bomber.core.bomber_pyo3.analysis"


class _FakeLookalikePyo3Statistic:
    __module__ = "bomber.core.bomber_pyo3_fake"

...
from bomber.analysis.tearsheet import PLOTLY_AVAILABLE
from bomber.analysis.tearsheet import _aggregate_period_returns
from bomber.analysis.tearsheet import _calculate_account_returns
from bomber.analysis.tearsheet import _create_stats_table
from bomber.analysis.tearsheet import _create_tearsheet_figure
from bomber.analysis.tearsheet import _normalize_theme_config
from bomber.analysis.tearsheet import _resolve_tearsheet_returns
...
def test_calculate_account_returns_uses_account_balance_changes(monkeypatch):
    ...
    monkeypatch.setattr(
        "bomber.analysis.reporter.ReportProvider.generate_account_report",
...
def test_create_tearsheet_uses_account_returns_instead_of_analyzer_returns(monkeypatch):
    ...
    monkeypatch.setattr(
        "bomber.analysis.tearsheet._calculate_account_returns",
    ...
    monkeypatch.setattr(
        "bomber.analysis.tearsheet.create_tearsheet_from_stats",
...
def test_create_tearsheet_raises_import_error_when_plotly_not_available(monkeypatch):
    # Arrange
    monkeypatch.setattr("bomber.analysis.tearsheet.PLOTLY_AVAILABLE", False)

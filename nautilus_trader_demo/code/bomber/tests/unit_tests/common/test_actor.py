...
from bomber.config import ActorConfig
...
from bomber.model.currencies import EUR
...
from bomber.test_kit.mocks.actors import KaboomActor
from bomber.test_kit.mocks.actors import MockActor
...
from bomber.trading.filters import NewsImpact
...
class TestActor:
    ...
    def test_actor_fully_qualified_name(self) -> None:
        ...
        assert result.actor_path == "bomber.common.actor:Actor"
        assert result.config_path == "bomber.common.config:ActorConfig"
    ...
    def test_subscribe_option_chain(self) -> None:
        # Arrange
        from bomber.core.bomber_pyo3 import OptionSeriesId

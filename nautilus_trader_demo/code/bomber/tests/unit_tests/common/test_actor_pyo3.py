...
from bomber.core.bomber_pyo3 import BookType
from bomber.core.bomber_pyo3 import ClientId
from bomber.core.bomber_pyo3 import DataActor
from bomber.core.bomber_pyo3 import DataType
...
def test_actor_creation():
    ...
    assert str(type(actor)) == "<class 'bomber.common.DataActor'>"
...
def test_unregistered_actor_properties_work():
    ...
    from bomber.core.bomber_pyo3 import ComponentState

...
from bomber.persistence.catalog.parquet import ParquetDataCatalog
from bomber.serialization.arrow.serializer import ArrowSerializer
from bomber.serialization.arrow.serializer import make_dict_serializer
...
class TestArrowSerializer:
    ...
    def test_serialize_and_deserialize_pyo3_instrument_status(self):
        ...
        instrument_id = bomber_pyo3.InstrumentId.from_str("AAPL.XNAS")
        status = bomber_pyo3.InstrumentStatus(
            instrument_id=instrument_id,
            action=bomber_pyo3.MarketStatusAction.TRADING,
        ...
        batch = ArrowSerializer.serialize_batch(
            [status],
            data_cls=bomber_pyo3.InstrumentStatus,
        )
        ...
        assert roundtripped.action == bomber_pyo3.MarketStatusAction.TRADING
    ...
    def test_serialize_and_deserialize_pyo3_option_greeks(self):
        ...
        instrument_id = bomber_pyo3.InstrumentId.from_str("BTC-20260529-100000-C.OKX")
        greeks = bomber_pyo3.OptionGreeks(
            instrument_id,
            0.55,
            0.012,
            3.4,
            ...
            1_000_000_000,
            1_000_000_001,
            bomber_pyo3.GreeksConvention.PRICE_ADJUSTED,
        )

        batch = ArrowSerializer.serialize_batch(
            [greeks],
            data_cls=bomber_pyo3.OptionGreeks,
        )
        assert isinstance(batch, pa.Table)
        assert batch.num_rows == 1
        ...
        assert roundtripped.ts_event == 1_000_000_000
        assert roundtripped.ts_init == 1_000_000_001
        assert roundtripped.convention == bomber_pyo3.GreeksConvention.PRICE_ADJUSTED
        ...
        assert queried[0].convention == bomber_pyo3.GreeksConvention.PRICE_ADJUSTED

...
from bomber.test_kit.mocks.strategies import KaboomStrategy
...
class TestStrategy:
    ...
    def test_strategy_to_importable_config_with_no_specific_config(self) -> None:
        ...
        assert result.strategy_path == "bomber.trading.strategy:Strategy"
        assert result.config_path == "bomber.trading.config:StrategyConfig"

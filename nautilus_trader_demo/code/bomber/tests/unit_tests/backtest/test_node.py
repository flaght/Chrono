...
import bomber.backtest.node as node
from bomber.adapters.tardis.loaders import TardisCSVDataLoader
...
from bomber.test_kit.mocks.data import load_catalog_with_stub_quote_ticks_audusd
...
from bomber.test_kit.providers import get_test_data_large_path
    ...
    def setup_method(self, tmp_path):
        ...
        self.strategies = [
            ImportableStrategyConfig(
                strategy_path="bomber.examples.strategies.ema_cross:EMACross",
                config_path="bomber.examples.strategies.ema_cross:EMACrossConfig",
                config={
                ...
                "data": [
                    {
                        ...
                        "data_cls": "bomber.model.data:QuoteTick",
                        "instrument_id": "AUD/USD.SIM",
                        "start_time": 1580398089820000000,
                        "end_time": 1580504394501000000,
                    },
...
class TestBacktestNodeStreaming:
    ...
    def test_streaming_mixed_builtin_and_custom_data_types(self, tmp_path):
        ...
        Regression test for
        https://github.com/nautechsystems/bomber/issues/3853

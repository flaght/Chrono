...
from bomber.config import NautilusConfig
from bomber.config import msgspec_decoding_hook
from bomber.config import msgspec_encoding_hook
from bomber.config import tokenize_config
...
class TestBacktestConfigParsing:
    ...
    def test_backtest_main_cli(self, mocker) -> None:
        # Arrange
        from bomber.backtest.__main__ import main
        ...
        # Act
        with mocker.patch("bomber.backtest.node.BacktestNode.run"):

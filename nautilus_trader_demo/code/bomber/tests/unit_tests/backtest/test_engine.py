...
from bomber.config import ImportableControllerConfig
from bomber.config import InvalidConfiguration
...
from bomber.examples.strategies.signal_strategy import SignalStrategy
from bomber.examples.strategies.signal_strategy import SignalStrategyConfig
...
from bomber.persistence import wranglers_v2
...
from bomber.test_kit.stubs.config import TestConfigStubs
from bomber.test_kit.stubs.data import MyData
from bomber.test_kit.stubs.data import TestDataStubs
from bomber.trading.messages import RemoveStrategy
    ...
    def test_controller(self):
        ...
        config = BacktestEngineConfig(
            ...
            controller=ImportableControllerConfig(
                controller_path="bomber.test_kit.mocks.controller:MyController",
                config_path="bomber.test_kit.mocks.controller:ControllerConfig",
                config={},
            ),
        )

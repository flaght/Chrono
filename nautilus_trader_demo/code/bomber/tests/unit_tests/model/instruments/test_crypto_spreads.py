...
def test_crypto_futures_spread_from_pyo3_round_trip_preserves_fractional():
    p_inst = bomber_pyo3.CryptoFuturesSpread(
        instrument_id=bomber_pyo3.InstrumentId.from_str("BTC-FS-19MAY26_PERP.DERIBIT"),
        raw_symbol=bomber_pyo3.Symbol("BTC-FS-19MAY26_PERP"),
        underlying=bomber_pyo3.Currency.from_str("BTC"),
        ...
        size_increment=bomber_pyo3.Quantity.from_str("1"),
        ts_event=0,
        ts_init=0,
    )
...
def test_crypto_option_spread_from_pyo3_round_trip_preserves_fractional():
    ...
    p_inst = bomber_pyo3.CryptoOptionSpread(
        instrument_id=bomber_pyo3.InstrumentId.from_str(
            "BTC-CS-19MAY26-70000_75000.DERIBIT",
        ),
        raw_symbol=bomber_pyo3.Symbol("BTC-CS-19MAY26-70000_75000"),
        underlying=bomber_pyo3.Currency.from_str("BTC"),
        quote_currency=bomber_pyo3.Currency.from_str("BTC"),
        settlement_currency=bomber_pyo3.Currency.from_str("BTC"),
        is_inverse=True,
        strategy_type="CS",
        activation_ns=0,
        ...
        price_precision=4,
        size_precision=1,
        price_increment=bomber_pyo3.Price.from_str("0.0001"),
        size_increment=bomber_pyo3.Quantity.from_str("0.1"),
        ts_event=0,
        ts_init=0,
    )

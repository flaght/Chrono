...
from bomber.core.bomber_pyo3 import Currency as Pyo3Currency
from bomber.core.bomber_pyo3 import InstrumentId
from bomber.core.bomber_pyo3 import Price as Pyo3Price
from bomber.core.bomber_pyo3 import Quantity as Pyo3Quantity
...
_XBTUSD_PERP_INVERSE = bomber_pyo3.PerpetualContract(
...
_ETHUSD_PERP_QUANTO = bomber_pyo3.PerpetualContract(
...
_ETHUSD_PERP_USD_STABLE_SETTLED = bomber_pyo3.PerpetualContract(
...
def test_to_dict():
    ...
    assert bomber_pyo3.PerpetualContract.from_dict(result) == _EURUSD_PERP
    assert result == {
...
def test_pyo3_cython_conversion():
    ...
    pyo3_back = bomber_pyo3.PerpetualContract.from_dict(cython_dict)

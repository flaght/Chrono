...
_ETHUSD_PERP_QUANTO = bomber_pyo3.CryptoPerpetual(
    instrument_id=bomber_pyo3.InstrumentId.from_str("ETHUSDQ-PERP.BITMEX"),
    raw_symbol=bomber_pyo3.Symbol("ETHUSDQ-PERP"),
    base_currency=bomber_pyo3.Currency.from_str("ETH"),
    quote_currency=bomber_pyo3.Currency.from_str("USD"),
    settlement_currency=bomber_pyo3.Currency.from_str("BTC"),
    is_inverse=False,
    price_precision=1,
    size_precision=0,
    price_increment=bomber_pyo3.Price.from_str("0.5"),
    size_increment=bomber_pyo3.Quantity.from_int(1),
    maker_fee=Decimal(0),
    taker_fee=Decimal(0),
    ...
    multiplier=None,
    lot_size=None,
    max_quantity=bomber_pyo3.Quantity.from_int(1_000_000),
    min_quantity=bomber_pyo3.Quantity.from_int(1),
    max_notional=None,
    min_notional=None,
    max_price=bomber_pyo3.Price.from_str("1000000.0"),
    min_price=bomber_pyo3.Price.from_str("0.5"),
    ts_event=0,
    ts_init=0,
)

_ETHUSD_PERP_USD_STABLE_SETTLED = bomber_pyo3.CryptoPerpetual(
    instrument_id=bomber_pyo3.InstrumentId.from_str("ETHUSD-STABLE-PERP.BITMEX"),
    raw_symbol=bomber_pyo3.Symbol("ETHUSD-STABLE-PERP"),
    base_currency=bomber_pyo3.Currency.from_str("ETH"),
    quote_currency=bomber_pyo3.Currency.from_str("USD"),
    settlement_currency=bomber_pyo3.Currency.from_str("USDT"),
    is_inverse=False,
    price_precision=1,
    size_precision=0,
    price_increment=bomber_pyo3.Price.from_str("0.5"),
...
def test_to_dict():
    ...
    assert bomber_pyo3.CryptoPerpetual.from_dict(result) == _ETHUSDT_PERP
    assert result == {
...
def test_from_dict_non_ascii_base_currency():
    # Regression for https://github.com/nautechsystems/bomber/issues/3893
    ...
    instrument = bomber_pyo3.CryptoPerpetual.from_dict(raw_instrument)
...
def test_pyo3_cython_conversion():
    ...
    crypto_perpetual_pyo3_back = bomber_pyo3.CryptoPerpetual.from_dict(

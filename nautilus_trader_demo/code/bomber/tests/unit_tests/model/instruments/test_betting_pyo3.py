...
def test_to_dict():
    ...
    assert bomber_pyo3.BettingInstrument.from_dict(result) == _BETTING_INSTRUMENT
    assert result == {
...
def test_from_dict_accepts_cython_tick_scheme_key():
    ...
    result = bomber_pyo3.BettingInstrument.from_dict(values)
...
#     binary_option_pyo3_back = bomber_pyo3.BinaryOption.from_dict(binary_option_cython_dict)

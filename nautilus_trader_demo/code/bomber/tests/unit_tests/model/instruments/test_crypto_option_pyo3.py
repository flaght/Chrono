...
_XBTUSD_OPTION_INVERSE = bomber_pyo3.CryptoOption(
...
_ETHUSD_OPTION_QUANTO = bomber_pyo3.CryptoOption(
...
_ETHUSD_OPTION_USD_STABLE_SETTLED = bomber_pyo3.CryptoOption(
...
def test_to_dict():
    ...
    assert bomber_pyo3.CryptoOption.from_dict(result) == _BTCUSD_OPTION
    assert result == {
        "type": "CryptoOption",
...
def test_pyo3_cython_conversion():
    ...
    crypto_option_pyo3_back = bomber_pyo3.CryptoOption.from_dict(crypto_option_cython_dict)

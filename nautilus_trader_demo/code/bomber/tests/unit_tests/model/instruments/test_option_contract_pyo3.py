...
def test_to_dict():
    ...
    assert bomber_pyo3.OptionContract.from_dict(result) == _AAPL_OPTION
    assert result == {
        "type": "OptionContract",
...
def test_pyo3_cython_conversion():
    ...
    option_contract_pyo3_back = bomber_pyo3.OptionContract.from_dict(
...
def test_activation_utc_with_zero_timestamp():
    ...
    option_pyo3 = bomber_pyo3.OptionContract.from_dict(option_dict)

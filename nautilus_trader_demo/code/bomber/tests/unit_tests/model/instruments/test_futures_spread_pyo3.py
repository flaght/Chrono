...
def test_to_dict():
    ...
    assert bomber_pyo3.FuturesSpread.from_dict(result) == _ES_FUTURES_SPREAD
    assert result == {
        "type": "FuturesSpread",
        "id": "ESM4-ESU4.GLBX",
...
def test_pyo3_cython_conversion():
    ...
    futures_spread_pyo3_back = bomber_pyo3.FuturesSpread.from_dict(futures_spread_cython_dict)

...
def test_to_dict():
    ...
    assert bomber_pyo3.Commodity.from_dict(result) == _COMMODITY
    assert result == {
        "type": "Commodity",
        "id": "CL.NYMEX",
        "raw_symbol": "CL",
...
def test_pyo3_cython_conversion():
    ...
    commodity_pyo3_back = bomber_pyo3.Commodity.from_dict(commodity_cython_dict)
...
def test_pyo3_cython_conversion_with_optional_fields():
    commodity_pyo3 = bomber_pyo3.Commodity(

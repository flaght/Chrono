...
class TestTradeTick:
    def test_fully_qualified_name(self):
        # Arrange, Act, Assert
        assert (
            IndexPriceUpdate.fully_qualified_name() == "bomber.model.data:IndexPriceUpdate"
        )
    ...
    def test_to_pyo3(self):
        ...
        # Assert
        assert isinstance(pyo3_index_price, bomber_pyo3.IndexPriceUpdate)
        assert pyo3_index_price.value == bomber_pyo3.Price.from_str("100_000.00")

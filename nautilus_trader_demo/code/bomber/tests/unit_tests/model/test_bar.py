...
class TestBar:
    def test_fully_qualified_name(self):
        # Arrange, Act, Assert
        assert Bar.fully_qualified_name() == "bomber.model.data:Bar"
    ...
    def test_to_pyo3(self):
        ...
        # Assert
        assert isinstance(pyo3_bar, bomber_pyo3.Bar)
        assert pyo3_bar.open == bomber_pyo3.Price.from_str("1.00000")
        assert pyo3_bar.high == bomber_pyo3.Price.from_str("1.00000")
        assert pyo3_bar.low == bomber_pyo3.Price.from_str("1.00000")
        assert pyo3_bar.close == bomber_pyo3.Price.from_str("1.00000")
        assert pyo3_bar.volume == bomber_pyo3.Quantity.from_int(100_000)

...
def test_delta_fully_qualified_name() -> None:
    # Arrange, Act, Assert
    assert OrderBookDelta.fully_qualified_name() == "bomber.model.data:OrderBookDelta"
...
def test_deltas_fully_qualified_name() -> None:
    # Arrange, Act, Assert
    assert OrderBookDeltas.fully_qualified_name() == "bomber.model.data:OrderBookDeltas"
...
def test_deltas_to_pyo3() -> None:
    ...
    # Assert
    assert isinstance(pyo3_deltas, bomber_pyo3.OrderBookDeltas)
...
def test_depth10_fully_qualified_name() -> None:
    # Arrange, Act, Assert
    assert OrderBookDepth10.fully_qualified_name() == "bomber.model.data:OrderBookDepth10"
...
def test_depth10_from_pyo3():
    # Arrange
    pyo3_depth = bomber_pyo3.OrderBookDepth10.get_stub()

...
class TestTradeTick:
    def test_fully_qualified_name(self):
        # Arrange, Act, Assert
        assert (
            MarkPriceUpdate.fully_qualified_name() == "bomber.model.data:MarkPriceUpdate"
        )
    ...
    def test_to_pyo3(self):
        ...
        # Assert
        assert isinstance(pyo3_mark_price, bomber_pyo3.MarkPriceUpdate)
        assert pyo3_mark_price.value == bomber_pyo3.Price.from_str("100_000.00")

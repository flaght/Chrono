...
def test_opposite_side_returns_expected_sides(side, expected):
    # Arrange, Act
    result = bomber_pyo3.MarketOrder.opposite_side(side)
...
def test_closing_side_returns_expected_sides(
    ...
    # Arrange, Act
    result = bomber_pyo3.MarketOrder.closing_side(side)
...
def test_pyo3_cython_conversion():
    ...
    market_order_pyo3_back = bomber_pyo3.MarketOrder.from_dict(market_order_cython_dict)

...
class TestFundingRateUpdate:
    def test_fully_qualified_name(self):
        ...
        assert (
            ...
            == "bomber.model.data:FundingRateUpdate"
        )
    ...
    def test_from_pyo3_minimal_fields(self):
        ...
        pyo3_funding_rate = bomber_pyo3.FundingRateUpdate(
            instrument_id=bomber_pyo3.InstrumentId.from_str("BTCUSDT-PERP.BINANCE"),
            rate="0.0001",
            ts_event=1_640_000_000_000_000_000,
            ts_init=1_640_000_000_000_000_000,
        )
    ...
    def test_from_pyo3_list(self):
        ...
        pyo3_funding_rates = [
            ...
            bomber_pyo3.FundingRateUpdate(
                instrument_id=bomber_pyo3.InstrumentId.from_str("ETHUSDT-PERP.BINANCE"),
                rate="0.0002",
                interval=60,
                next_funding_ns=1_640_000_100_000_000_000,

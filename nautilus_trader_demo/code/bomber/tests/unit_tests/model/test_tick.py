...
from bomber.model import convert_to_raw_int
...
class TestQuoteTick:
    ...
    def test_fully_qualified_name(self):
        # Arrange, Act, Assert
        assert QuoteTick.fully_qualified_name() == "bomber.model.data:QuoteTick"
    ...
    def test_to_pyo3(self):
        ...
        # Assert
        assert isinstance(pyo3_quote, bomber_pyo3.QuoteTick)
        assert pyo3_quote.bid_price == bomber_pyo3.Price.from_str("1.00000")
        assert pyo3_quote.ask_price == bomber_pyo3.Price.from_str("1.00001")
        assert pyo3_quote.bid_size == bomber_pyo3.Quantity.from_int(1)
        assert pyo3_quote.ask_size == bomber_pyo3.Quantity.from_int(2)
...
class TestTradeTick:
    def test_fully_qualified_name(self):
        # Arrange, Act, Assert
        assert TradeTick.fully_qualified_name() == "bomber.model.data:TradeTick"
    ...
    def test_to_pyo3(self):
        ...
        # Assert
        assert isinstance(pyo3_trade, bomber_pyo3.TradeTick)
        assert pyo3_trade.price == bomber_pyo3.Price.from_str("1.00000")
        assert pyo3_trade.size == bomber_pyo3.Quantity.from_int(10_000)
        assert pyo3_trade.aggressor_side == bomber_pyo3.AggressorSide.BUYER
        assert pyo3_trade.trade_id == bomber_pyo3.TradeId.from_str("123456789")

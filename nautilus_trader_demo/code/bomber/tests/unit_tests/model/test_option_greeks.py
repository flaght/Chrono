...
class TestOptionGreeks:
    def test_default_convention_is_black_scholes(self):
        ...
        # Assert
        assert greeks.convention == bomber_pyo3.GreeksConvention.BLACK_SCHOLES
    ...
    def test_convention_is_readonly(self):
        ...
        with pytest.raises(AttributeError):
            greeks.convention = bomber_pyo3.GreeksConvention.PRICE_ADJUSTED
    ...
    def test_from_pyo3_preserves_convention(self, convention):
        ...
        pyo3_greeks = bomber_pyo3.OptionGreeks(
            bomber_pyo3.InstrumentId.from_str(str(BTCUSDT_BINANCE.id)),
            0.55,
            0.02,
            0.15,
            -0.05,

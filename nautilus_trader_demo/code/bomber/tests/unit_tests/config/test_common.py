...
from bomber.common.config import CUSTOM_DECODINGS
from bomber.common.config import CUSTOM_ENCODINGS
from bomber.common.config import ActorConfig
from bomber.common.config import pyo3_config_json
from bomber.config import DatabaseConfig
...
from bomber.config import register_config_decoding
from bomber.config import register_config_encoding
...
def test_fully_qualified_name() -> None:
    ...
    # Act, Assert
    assert config.fully_qualified_name() == "bomber.common.config:DatabaseConfig"
...
def test_importable_config_rejects_unknown_nested_field() -> None:
    ...
    raw = msgspec.json.encode(
        {
            "path": "bomber.live.config:LiveDataClientConfig",
            "config": {
                "instrument_provider": {
...
def test_encoding_type_with_fully_qualified_name() -> None:
    ...
    # Assert
    assert result == "bomber.common.config:DatabaseConfig"

...
This document describes how Bomber classifies adapters, the path between
...
Maintained in the [bomber](https://github.com/nautechsystems/bomber)
...
alignment with the Bomber domain model and standard adapter patterns.
...
Bomber maintainers provide support for official adapters only. Issues
with community or external adapters should be directed to their respective
maintainers.

If you believe an issue originates in the Bomber core rather than a
third-party adapter, please file a minimal reproducible example against the
[core repository](https://github.com/nautechsystems/bomber/issues).
...
listing criteria or misrepresents its relationship to Bomber.

### Community adapters

Community adapters are externally maintained and are not supported by Bomber maintainers.

...
from bomber.cache.base import CacheFacade
from bomber.cache.cache import Cache
from bomber.cache.database import CacheDatabaseAdapter
from bomber.common import Environment
from bomber.common.actor import Actor
from bomber.common.component import Clock
from bomber.common.component import LiveClock
from bomber.common.component import Logger
from bomber.common.component import LogGuard
from bomber.common.component import MessageBus
from bomber.common.component import TestClock
from bomber.common.component import init_logging
from bomber.common.component import is_backtest_force_stop
from bomber.common.component import is_logging_initialized
from bomber.common.component import log_header
from bomber.common.component import register_component_clock
from bomber.common.component import set_backtest_force_stop
from bomber.common.component import set_logging_pyo3
from bomber.common.config import InvalidConfiguration
from bomber.common.config import pyo3_config_json
from bomber.common.enums import LogColor
from bomber.common.enums import LogLevel
from bomber.common.enums import log_level_from_str
from bomber.common.messages import ShutdownSystem
from bomber.config import ActorFactory
from bomber.config import ControllerFactory
from bomber.config import DataEngineConfig
from bomber.config import ExecAlgorithmFactory
...
from bomber.config import LiveRiskEngineConfig
from bomber.config import LoggingConfig
from bomber.config import NautilusKernelConfig
from bomber.config import RiskEngineConfig
from bomber.config import StrategyFactory
...
from bomber.execution.algorithm import ExecAlgorithm
from bomber.execution.emulator import OrderEmulator
from bomber.execution.engine import ExecutionEngine
from bomber.live.data_engine import LiveDataEngine
from bomber.live.execution_engine import LiveExecutionEngine
from bomber.live.risk_engine import LiveRiskEngine
from bomber.model.identifiers import TraderId
from bomber.persistence.catalog import BaseDataCatalog
from bomber.persistence.writer import StreamingFeatherWriter
...
from bomber.serialization.serializer import MsgSpecSerializer
from bomber.trading.controller import Controller
...
class NautilusKernel:
    ...
    def __init__(  # noqa: C901 (too complex)
        ...
        self._log_guard: bomber_pyo3.LogGuard | LogGuard | None = None
        ...
        if not is_logging_initialized():
            if not logging.bypass_logging:
                if logging.use_pyo3:
                    ...
                    self._log_guard = bomber_pyo3.init_logging(
                        trader_id=bomber_pyo3.TraderId(self._trader_id.value),
                        instance_id=bomber_pyo3.UUID4.from_str(self._instance_id.value),
                        level_stdout=bomber_pyo3.LogLevel(logging.log_level),
                        level_file=bomber_pyo3.LogLevel(logging.log_level_file or "OFF"),
        ...
        if logging.use_tracing and not bomber_pyo3.tracing_is_initialized():
            bomber_pyo3.init_tracing()
        ...
        if not config.message_bus or not config.message_bus.database:
            ...
            self._msgbus_db = bomber_pyo3.RedisMessageBusDatabase(
                trader_id=bomber_pyo3.TraderId(self._trader_id.value),
                instance_id=bomber_pyo3.UUID4.from_str(self._instance_id.value),

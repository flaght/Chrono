...
from bomber.core.rust.core cimport CVec
from bomber.core.rust.core cimport millis_to_nanos
from bomber.core.rust.core cimport secs_to_nanos
from bomber.core.rust.model cimport DEPTH10_LEN
from bomber.core.rust.model cimport AggregationSource
from bomber.core.rust.model cimport AggressorSide
from bomber.core.rust.model cimport Bar_t
from bomber.core.rust.model cimport BarSpecification_t
from bomber.core.rust.model cimport BarType_t
from bomber.core.rust.model cimport BookAction
from bomber.core.rust.model cimport BookOrder_t
from bomber.core.rust.model cimport Data_t
from bomber.core.rust.model cimport Data_t_Tag
from bomber.core.rust.model cimport IndexPriceUpdate_t
from bomber.core.rust.model cimport InstrumentCloseType
from bomber.core.rust.model cimport MarketStatusAction
from bomber.core.rust.model cimport MarkPriceUpdate_t
from bomber.core.rust.model cimport OrderSide
from bomber.core.rust.model cimport Price_t
from bomber.core.rust.model cimport PriceRaw
from bomber.core.rust.model cimport PriceType
from bomber.core.rust.model cimport Quantity_t
from bomber.core.rust.model cimport QuantityRaw
from bomber.core.rust.model cimport RecordFlag
from bomber.core.rust.model cimport bar_eq
from bomber.core.rust.model cimport bar_hash
from bomber.core.rust.model cimport bar_new
from bomber.core.rust.model cimport bar_specification_eq
from bomber.core.rust.model cimport bar_specification_ge
from bomber.core.rust.model cimport bar_specification_gt
from bomber.core.rust.model cimport bar_specification_hash
from bomber.core.rust.model cimport bar_specification_le
from bomber.core.rust.model cimport bar_specification_lt
from bomber.core.rust.model cimport bar_specification_new
from bomber.core.rust.model cimport bar_specification_to_cstr
from bomber.core.rust.model cimport bar_to_cstr
from bomber.core.rust.model cimport bar_type_aggregation_source
from bomber.core.rust.model cimport bar_type_check_parsing
from bomber.core.rust.model cimport bar_type_composite
from bomber.core.rust.model cimport bar_type_eq
from bomber.core.rust.model cimport bar_type_from_cstr
from bomber.core.rust.model cimport bar_type_ge
from bomber.core.rust.model cimport bar_type_gt
from bomber.core.rust.model cimport bar_type_hash
from bomber.core.rust.model cimport bar_type_instrument_id
from bomber.core.rust.model cimport bar_type_is_composite
from bomber.core.rust.model cimport bar_type_is_standard
from bomber.core.rust.model cimport bar_type_le
from bomber.core.rust.model cimport bar_type_lt
from bomber.core.rust.model cimport bar_type_new
from bomber.core.rust.model cimport bar_type_new_composite
from bomber.core.rust.model cimport bar_type_spec
from bomber.core.rust.model cimport bar_type_standard
from bomber.core.rust.model cimport bar_type_to_cstr
from bomber.core.rust.model cimport book_order_debug_to_cstr
from bomber.core.rust.model cimport book_order_eq
from bomber.core.rust.model cimport book_order_exposure
from bomber.core.rust.model cimport book_order_hash
from bomber.core.rust.model cimport book_order_new
from bomber.core.rust.model cimport book_order_signed_size
from bomber.core.rust.model cimport index_price_update_eq
from bomber.core.rust.model cimport index_price_update_hash
from bomber.core.rust.model cimport index_price_update_new
from bomber.core.rust.model cimport index_price_update_to_cstr
from bomber.core.rust.model cimport instrument_id_from_cstr
from bomber.core.rust.model cimport mark_price_update_eq
from bomber.core.rust.model cimport mark_price_update_hash
from bomber.core.rust.model cimport mark_price_update_new
from bomber.core.rust.model cimport mark_price_update_to_cstr
from bomber.core.rust.model cimport orderbook_delta_eq
from bomber.core.rust.model cimport orderbook_delta_hash
from bomber.core.rust.model cimport orderbook_delta_new
from bomber.core.rust.model cimport orderbook_deltas_clone
from bomber.core.rust.model cimport orderbook_deltas_drop
from bomber.core.rust.model cimport orderbook_deltas_flags
from bomber.core.rust.model cimport orderbook_deltas_instrument_id
from bomber.core.rust.model cimport orderbook_deltas_is_snapshot
from bomber.core.rust.model cimport orderbook_deltas_new
from bomber.core.rust.model cimport orderbook_deltas_sequence
from bomber.core.rust.model cimport orderbook_deltas_ts_event
from bomber.core.rust.model cimport orderbook_deltas_ts_init
from bomber.core.rust.model cimport orderbook_deltas_vec_deltas
from bomber.core.rust.model cimport orderbook_deltas_vec_drop
from bomber.core.rust.model cimport orderbook_depth10_ask_counts_array
from bomber.core.rust.model cimport orderbook_depth10_asks_array
from bomber.core.rust.model cimport orderbook_depth10_bid_counts_array
from bomber.core.rust.model cimport orderbook_depth10_bids_array
from bomber.core.rust.model cimport orderbook_depth10_clone
from bomber.core.rust.model cimport orderbook_depth10_eq
from bomber.core.rust.model cimport orderbook_depth10_hash
from bomber.core.rust.model cimport orderbook_depth10_new
from bomber.core.rust.model cimport price_from_raw
from bomber.core.rust.model cimport quantity_from_raw
from bomber.core.rust.model cimport quote_tick_eq
from bomber.core.rust.model cimport quote_tick_hash
from bomber.core.rust.model cimport quote_tick_new
from bomber.core.rust.model cimport quote_tick_to_cstr
from bomber.core.rust.model cimport symbol_new
from bomber.core.rust.model cimport trade_id_new
from bomber.core.rust.model cimport trade_tick_eq
from bomber.core.rust.model cimport trade_tick_hash
from bomber.core.rust.model cimport trade_tick_new
from bomber.core.rust.model cimport trade_tick_to_cstr
from bomber.core.rust.model cimport venue_new
from bomber.core.string cimport cstr_to_pystr
from bomber.core.string cimport pystr_to_cstr
from bomber.core.string cimport ustr_to_pystr
from bomber.model.data cimport BarAggregation
from bomber.model.data cimport BarIntervalType
from bomber.model.functions cimport aggregation_source_from_str
from bomber.model.functions cimport aggressor_side_from_str
from bomber.model.functions cimport aggressor_side_to_str
from bomber.model.functions cimport bar_aggregation_from_str
from bomber.model.functions cimport bar_aggregation_to_str
from bomber.model.functions cimport book_action_from_str
from bomber.model.functions cimport book_action_to_str
from bomber.model.functions cimport instrument_close_type_from_str
from bomber.model.functions cimport instrument_close_type_to_str
from bomber.model.functions cimport market_status_action_from_str
from bomber.model.functions cimport market_status_action_to_str
from bomber.model.functions cimport order_side_from_str
from bomber.model.functions cimport order_side_to_str
from bomber.model.functions cimport price_type_from_str
from bomber.model.functions cimport price_type_to_str
from bomber.model.identifiers cimport InstrumentId
from bomber.model.identifiers cimport Symbol
...
from bomber.model.objects cimport price_new
from bomber.model.objects cimport quantity_new
...
cdef class Bar(Data):
    ...
    @staticmethod
    def to_pyo3_list(list bars) -> list[bomber_pyo3.Bar]:
        """
        ...
        for bar in bars:
            if pyo3_bar_type is None:
                ...
                pyo3_bar_type = bomber_pyo3.BarType.from_str(bar_type.to_str())
                price_prec = bar._mem.open.precision
                volume_prec = bar._mem.volume.precision

            pyo3_bar = bomber_pyo3.Bar(
                pyo3_bar_type,
                bomber_pyo3.Price.from_raw(bar._mem.open.raw, price_prec),
                bomber_pyo3.Price.from_raw(bar._mem.high.raw, price_prec),
                bomber_pyo3.Price.from_raw(bar._mem.low.raw, price_prec),
                bomber_pyo3.Price.from_raw(bar._mem.close.raw, price_prec),
                bomber_pyo3.Quantity.from_raw(bar._mem.volume.raw, volume_prec),
                bar._mem.ts_event,
                bar._mem.ts_init,
            )
    ...
    def from_pyo3_list(list pyo3_bars) -> list[Bar]:
        ...
        Parameters
        ----------
        pyo3_bars : list[bomber_pyo3.Bar]
    ...
    def to_pyo3(self) -> bomber_pyo3.Bar:
        """
        ...
        """
        return bomber_pyo3.Bar(
            bomber_pyo3.BarType.from_str(BarType.from_mem_c(self._mem.bar_type).to_str()),
            bomber_pyo3.Price.from_raw(self._mem.open.raw, self._mem.open.precision),
            bomber_pyo3.Price.from_raw(self._mem.high.raw, self._mem.high.precision),
            bomber_pyo3.Price.from_raw(self._mem.low.raw, self._mem.low.precision),
            bomber_pyo3.Price.from_raw(self._mem.close.raw, self._mem.close.precision),
            bomber_pyo3.Quantity.from_raw(self._mem.volume.raw, self._mem.volume.precision),
            self._mem.ts_event,
            self._mem.ts_init,
        )
...
cdef class OrderBookDelta(Data):
    ...
    @staticmethod
    def to_pyo3_list(list[OrderBookDelta] deltas) -> list[bomber_pyo3.OrderBookDelta]:
        """
        ...
        Returns
        -------
        list[bomber_pyo3.OrderBookDelta]
        ...
        for delta in deltas:
            if pyo3_instrument_id is None:
                pyo3_instrument_id = bomber_pyo3.InstrumentId.from_str(delta.instrument_id.value)
            if price_prec == 0:
            ...
            pyo3_book_order = bomber_pyo3.BookOrder(
               bomber_pyo3.OrderSide(order_side_to_str(delta._mem.order.side)),
               bomber_pyo3.Price.from_raw(
                   delta._mem.order.price.raw,
                   delta._mem.order.price.precision if delta._mem.order.price.precision == 0 else price_prec,
               ),
               bomber_pyo3.Quantity.from_raw(
            ...
            pyo3_delta = bomber_pyo3.OrderBookDelta(
                pyo3_instrument_id,
                bomber_pyo3.BookAction(book_action_to_str(delta._mem.action)),
                pyo3_book_order,
                delta._mem.flags,
                delta._mem.sequence,
                delta._mem.ts_event,
    ...
    def from_pyo3_list(list pyo3_deltas) -> list[OrderBookDelta]:
        ...
        Parameters
        ----------
        pyo3_deltas : list[bomber_pyo3.OrderBookDelta]
            The pyo3 Rust order book deltas to convert from.
...
cdef class OrderBookDeltas(Data):
    ...
    def from_pyo3(pyo3_deltas) -> OrderBookDeltas:
        ...
        Parameters
        ----------
        pyo3_deltas : bomber_pyo3.OrderBookDeltas
    ...
    cpdef to_pyo3(self):
        ...
        Returns
        -------
        bomber_pyo3.OrderBookDeltas

        """
        capsule = self.to_capsule()
        deltas = bomber_pyo3.OrderBookDeltas.from_pycapsule(capsule)
        return deltas
...
cdef class OrderBookDepth10(Data):
    ...
    def from_pyo3(pyo3_depth) -> OrderBookDepth10:
        ...
        Parameters
        ----------
        pyo3_depth : bomber_pyo3.OrderBookDepth10
    ...
    def from_pyo3_list(pyo3_depths) -> list[OrderBookDepth10]:
        ...
        Parameters
        ----------
        pyo3_depths : bomber_pyo3.OrderBookDepth10
...
cdef class InstrumentStatus(Data):
    ...
    def from_pyo3_list(list pyo3_status_list) -> list[QuoteTick]:
        ...
        Parameters
        ----------
        pyo3_status_list : list[bomber_pyo3.InstrumentStatus]
    ...
    def from_pyo3(pyo3_status) -> InstrumentStatus:
        ...
        Parameters
        ----------
        pyo3_status : bomber_pyo3.InstrumentStatus
    ...
    def to_pyo3(self) -> bomber_pyo3.InstrumentStatus:
        """
        Return a pyo3 object from this legacy Cython instance.

        Returns
        -------
        bomber_pyo3.InstrumentStatus

        """
        return bomber_pyo3.InstrumentStatus(
            bomber_pyo3.InstrumentId.from_str(self.instrument_id.value),
            bomber_pyo3.MarketStatusAction(market_status_action_to_str(self.action)),
            self.ts_event,
            self.ts_init,
            self.reason,
            self.trading_event,
...
cdef class InstrumentClose(Data):
    ...
    @staticmethod
    def to_pyo3_list(list[InstrumentClose] closes) -> list[bomber_pyo3.InstrumentClose]:
        """
        ...
        Returns
        -------
        list[bomber_pyo3.InstrumentClose]
        ...
        for close in closes:
            if pyo3_instrument_id is None:
                pyo3_instrument_id = bomber_pyo3.InstrumentId.from_str(close.instrument_id.value)
                price_prec = close.close_price.precision

            pyo3_close = bomber_pyo3.InstrumentClose(
                pyo3_instrument_id,
                bomber_pyo3.Price(float(close.close_price), price_prec),
                bomber_pyo3.InstrumentCloseType(instrument_close_type_to_str(close.close_type)),
                close.ts_event,
                close.ts_init,
            )
    ...
    def from_pyo3_list(list pyo3_closes) -> list[InstrumentClose]:
        ...
        Parameters
        ----------
        pyo3_closes : list[bomber_pyo3.InstrumentClose]
    ...
    def from_pyo3(pyo3_close) -> InstrumentClose:
        ...
        Parameters
        ----------
        pyo3_close : bomber_pyo3InstrumentClose.
    ...
    def to_pyo3(self) -> bomber_pyo3.InstrumentClose:
        """
        Return a pyo3 object from this legacy Cython instance.

        Returns
        -------
        bomber_pyo3.InstrumentClose

        """
        return bomber_pyo3.InstrumentClose(
            bomber_pyo3.InstrumentId.from_str(self.instrument_id.value),
            bomber_pyo3.Price(float(self.close_price), self.close_price.precision),
            bomber_pyo3.InstrumentCloseType(instrument_close_type_to_str(self.close_type)),
            self.ts_event,
            self.ts_init,
        )
...
cdef class QuoteTick(Data):
    ...
    def from_pyo3_list(list pyo3_quotes) -> list[QuoteTick]:
        ...
        Parameters
        ----------
        pyo3_quotes : list[bomber_pyo3.QuoteTick]
    ...
    @staticmethod
    def to_pyo3_list(list[QuoteTick] quotes) -> list[bomber_pyo3.QuoteTick]:
        """
        ...
        for quote in quotes:
            if pyo3_instrument_id is None:
                pyo3_instrument_id = bomber_pyo3.InstrumentId.from_str(quote.instrument_id.value)
            ...
            pyo3_quote = bomber_pyo3.QuoteTick(
                pyo3_instrument_id,
                bomber_pyo3.Price.from_raw(quote._mem.bid_price.raw, bid_prec),
                bomber_pyo3.Price.from_raw(quote._mem.ask_price.raw, ask_prec),
                bomber_pyo3.Quantity.from_raw(quote._mem.bid_size.raw, bid_size_prec),
                bomber_pyo3.Quantity.from_raw(quote._mem.ask_size.raw, ask_size_prec),
                quote._mem.ts_event,
                quote._mem.ts_init,
            )
    ...
    def to_pyo3(self) -> bomber_pyo3.QuoteTick:
        """
        Return a pyo3 object from this legacy Cython instance.
        ...
        """
        return bomber_pyo3.QuoteTick(
            bomber_pyo3.InstrumentId.from_str(self.instrument_id.value),
            bomber_pyo3.Price.from_raw(self._mem.bid_price.raw, self._mem.bid_price.precision),
            bomber_pyo3.Price.from_raw(self._mem.ask_price.raw, self._mem.ask_price.precision),
            bomber_pyo3.Quantity.from_raw(self._mem.bid_size.raw, self._mem.bid_size.precision),
            bomber_pyo3.Quantity.from_raw(self._mem.ask_size.raw, self._mem.ask_size.precision),
            self._mem.ts_event,
            self._mem.ts_init,
        )
...
cdef class TradeTick(Data):
    ...
    @staticmethod
    def to_pyo3_list(list[TradeTick] trades) -> list[bomber_pyo3.TradeTick]:
        """
        ...
        for trade in trades:
            if pyo3_instrument_id is None:
                pyo3_instrument_id = bomber_pyo3.InstrumentId.from_str(trade.instrument_id.value)
                price_prec = trade.price.precision
                size_prec = trade.size.precision

            pyo3_trade = bomber_pyo3.TradeTick(
                pyo3_instrument_id,
                bomber_pyo3.Price.from_raw(trade._mem.price.raw, price_prec),
                bomber_pyo3.Quantity.from_raw(trade._mem.size.raw, size_prec),
                bomber_pyo3.AggressorSide(aggressor_side_to_str(trade._mem.aggressor_side)),
                bomber_pyo3.TradeId(trade.trade_id.value),
                trade._mem.ts_event,
                trade._mem.ts_init,
            )
    ...
    def from_pyo3_list(list pyo3_trades) -> list[TradeTick]:
        ...
        Parameters
        ----------
        pyo3_trades : list[bomber_pyo3.TradeTick]
    ...
    def to_pyo3(self) -> bomber_pyo3.TradeTick:
        """
        Return a pyo3 object from this legacy Cython instance.
        ...
        """
        return bomber_pyo3.TradeTick(
            bomber_pyo3.InstrumentId.from_str(self.instrument_id.value),
            bomber_pyo3.Price.from_raw(self._mem.price.raw, self._mem.price.precision),
            bomber_pyo3.Quantity.from_raw(self._mem.size.raw, self._mem.size.precision),
            bomber_pyo3.AggressorSide(aggressor_side_to_str(self._mem.aggressor_side)),
            bomber_pyo3.TradeId(self.trade_id.value),
            self._mem.ts_event,
            self._mem.ts_init,
        )
...
cdef class MarkPriceUpdate(Data):
    ...
    @staticmethod
    def to_pyo3_list(list[MarkPriceUpdate] mark_prices) -> list[bomber_pyo3.MarkPriceUpdate]:
        """
        ...
        Returns
        -------
        list[bomber_pyo3.MarkPriceUpdate]
        ...
        for mark_price in mark_prices:
            if pyo3_instrument_id is None:
                pyo3_instrument_id = bomber_pyo3.InstrumentId.from_str(mark_price.instrument_id.value)
                price_prec = mark_price.value.precision

            pyo3_mark_price = bomber_pyo3.MarkPriceUpdate(
                pyo3_instrument_id,
                bomber_pyo3.Price(float(mark_price.value), price_prec),
                mark_price.ts_event,
                mark_price.ts_init,
            )
    ...
    def from_pyo3_list(list pyo3_mark_prices) -> list[MarkPriceUpdate]:
        ...
        Parameters
        ----------
        pyo3_mark_prices : list[bomber_pyo3.MarkPriceUpdate]
    ...
    def from_pyo3(pyo3_mark_price) -> MarkPriceUpdate:
        ...
        Parameters
        ----------
        pyo3_trade : bomber_pyo3.MarkPriceUpdate
    ...
    def to_pyo3(self) -> bomber_pyo3.MarkPriceUpdate:
        """
        Return a pyo3 object from this legacy Cython instance.

        Returns
        -------
        bomber_pyo3.MarkPriceUpdate

        """
        return bomber_pyo3.MarkPriceUpdate(
            bomber_pyo3.InstrumentId.from_str(self.instrument_id.value),
            bomber_pyo3.Price(float(self.value), self.value.precision),
            self.ts_event,
            self.ts_init,
        )
...
cdef class IndexPriceUpdate(Data):
    ...
    @staticmethod
    def to_pyo3_list(list[IndexPriceUpdate] index_prices) -> list[bomber_pyo3.IndexPriceUpdate]:
        """
        Return pyo3 Rust index prices converted from the given legacy Cython objects.
        ...
        Returns
        -------
        list[bomber_pyo3.IndexPriceUpdate]
        ...
        for index_price in index_prices:
            if pyo3_instrument_id is None:
                pyo3_instrument_id = bomber_pyo3.InstrumentId.from_str(index_price.instrument_id.value)
                price_prec = index_price.value.precision

            pyo3_index_price = bomber_pyo3.IndexPriceUpdate(
                pyo3_instrument_id,
                bomber_pyo3.Price(float(index_price.value), price_prec),
    ...
    def from_pyo3_list(list pyo3_index_prices) -> list[IndexPriceUpdate]:
        ...
        Parameters
        ----------
        pyo3_index_prices : list[bomber_pyo3.IndexPriceUpdate]
    ...
    def from_pyo3(pyo3_index_price) -> IndexPriceUpdate:
        ...
        Parameters
        ----------
        pyo3_trade : bomber_pyo3.IndexPriceUpdate
    ...
    def to_pyo3(self) -> bomber_pyo3.IndexPriceUpdate:
        """
        Return a pyo3 object from this legacy Cython instance.

        Returns
        -------
        bomber_pyo3.IndexPriceUpdate

        """
        return bomber_pyo3.IndexPriceUpdate(
            bomber_pyo3.InstrumentId.from_str(self.instrument_id.value),
            bomber_pyo3.Price(float(self.value), self.value.precision),
            self.ts_event,
            self.ts_init,
...
cdef class FundingRateUpdate(Data):
    ...
    def from_pyo3_list(list pyo3_funding_rates) -> list[FundingRateUpdate]:
        ...
        Parameters
        ----------
        pyo3_funding_rates : list[bomber_pyo3.FundingRateUpdate]
    ...
    def from_pyo3(pyo3_funding_rate) -> FundingRateUpdate:
        ...
        Parameters
        ----------
        pyo3_funding_rate : bomber_pyo3.FundingRateUpdate
...
cdef class OptionGreeks(Data):
    ...
    def __init__(
        ...
        self.convention = convention if convention is not None else bomber_pyo3.GreeksConvention.BLACK_SCHOLES
        self.ts_event = ts_event
        self.ts_init = ts_init
    ...
    def from_pyo3(pyo3_greeks) -> OptionGreeks:
        ...
        Parameters
        ----------
        pyo3_greeks : bomber_pyo3.OptionGreeks
    ...
    def to_pyo3(self) -> bomber_pyo3.OptionGreeks:
        """
        Return a pyo3 object from this legacy Cython instance.

        Returns
        -------
        bomber_pyo3.OptionGreeks

        """
        return bomber_pyo3.OptionGreeks(
            bomber_pyo3.InstrumentId.from_str(self.instrument_id.value),
            self.delta,
            self.gamma,
            self.vega,

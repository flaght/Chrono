...
from bomber.model.functions cimport option_kind_from_str
from bomber.model.functions cimport option_kind_to_str
...
from bomber.model.instruments.base cimport Price
from bomber.model.instruments.base cimport settlement_currency_differs_for_quanto
...
cdef class CryptoOption(Instrument):
    ...
    def from_pyo3(pyo3_instrument) -> CryptoOption:
        ...
        Parameters
        ----------
        pyo3_instrument : bomber_pyo3.CryptoOption

...
from bomber.core.rust.core cimport min_increment_precision_from_cstr
from bomber.core.rust.model cimport AssetClass
from bomber.core.rust.model cimport InstrumentClass
from bomber.core.string cimport pystr_to_cstr
from bomber.model.functions cimport asset_class_from_str
from bomber.model.functions cimport asset_class_to_str
from bomber.model.functions cimport instrument_class_from_str
from bomber.model.functions cimport instrument_class_to_str
...
from bomber.model.tick_scheme.base cimport TICK_SCHEMES
from bomber.model.tick_scheme.base cimport get_tick_scheme
...
cpdef list[Instrument] instruments_from_pyo3(list pyo3_instruments):
    ...
    for pyo3_instrument in pyo3_instruments:
        if isinstance(pyo3_instrument, bomber_pyo3.BettingInstrument):
            instruments.append(BettingInstrument.from_pyo3_c(pyo3_instrument))
        elif isinstance(pyo3_instrument, bomber_pyo3.BinaryOption):
            instruments.append(BinaryOption.from_pyo3_c(pyo3_instrument))
        elif isinstance(pyo3_instrument, bomber_pyo3.Cfd):
            instruments.append(Cfd.from_pyo3_c(pyo3_instrument))
        elif isinstance(pyo3_instrument, bomber_pyo3.Commodity):
            instruments.append(Commodity.from_pyo3_c(pyo3_instrument))
        elif isinstance(pyo3_instrument, bomber_pyo3.CryptoPerpetual):
            instruments.append(CryptoPerpetual.from_pyo3_c(pyo3_instrument))
        elif isinstance(pyo3_instrument, bomber_pyo3.CryptoFuture):
            instruments.append(CryptoFuture.from_pyo3_c(pyo3_instrument))
        elif isinstance(pyo3_instrument, bomber_pyo3.CryptoFuturesSpread):
            instruments.append(CryptoFuturesSpread.from_pyo3_c(pyo3_instrument))
        elif isinstance(pyo3_instrument, bomber_pyo3.CryptoOption):
            instruments.append(CryptoOption.from_pyo3_c(pyo3_instrument))
        elif isinstance(pyo3_instrument, bomber_pyo3.CryptoOptionSpread):
            instruments.append(CryptoOptionSpread.from_pyo3_c(pyo3_instrument))
        elif isinstance(pyo3_instrument, bomber_pyo3.CurrencyPair):
            instruments.append(CurrencyPair.from_pyo3_c(pyo3_instrument))
        elif isinstance(pyo3_instrument, bomber_pyo3.Equity):
            instruments.append(Equity.from_pyo3_c(pyo3_instrument))
        elif isinstance(pyo3_instrument, bomber_pyo3.FuturesContract):
            instruments.append(FuturesContract.from_pyo3_c(pyo3_instrument))
        elif isinstance(pyo3_instrument, bomber_pyo3.FuturesSpread):
            instruments.append(FuturesSpread.from_pyo3_c(pyo3_instrument))
        elif isinstance(pyo3_instrument, bomber_pyo3.IndexInstrument):
            instruments.append(IndexInstrument.from_pyo3_c(pyo3_instrument))
        elif isinstance(pyo3_instrument, bomber_pyo3.OptionContract):
            instruments.append(OptionContract.from_pyo3_c(pyo3_instrument))
        elif isinstance(pyo3_instrument, bomber_pyo3.OptionSpread):
            instruments.append(OptionSpread.from_pyo3_c(pyo3_instrument))
        elif isinstance(pyo3_instrument, bomber_pyo3.PerpetualContract):
            instruments.append(PerpetualContract.from_pyo3_c(pyo3_instrument))
        elif isinstance(pyo3_instrument, bomber_pyo3.TokenizedAsset):

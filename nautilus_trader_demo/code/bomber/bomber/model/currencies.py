...
def register_currency(currency: Currency, overwrite: bool = False) -> None:
    ...
    (bomber.model.objects.Currency) and PyO3-based code
    (bomber.core.bomber_pyo3.Currency).
    ...
    pyo3_currency_type = bomber_pyo3.CurrencyType.from_str(currency.currency_type.name)

    pyo3_currency = bomber_pyo3.Currency(
        code=currency.code,
    ...
    bomber_pyo3.Currency.register(pyo3_currency, overwrite)

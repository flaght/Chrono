...
from bomber.core.rust.core cimport STACKSTR_CAPACITY
from bomber.core.rust.model cimport account_id_new
from bomber.core.rust.model cimport client_id_new
from bomber.core.rust.model cimport client_order_id_new
from bomber.core.rust.model cimport component_id_new
from bomber.core.rust.model cimport exec_algorithm_id_new
from bomber.core.rust.model cimport instrument_id_check_parsing
from bomber.core.rust.model cimport instrument_id_from_cstr
from bomber.core.rust.model cimport instrument_id_is_synthetic
from bomber.core.rust.model cimport instrument_id_new
from bomber.core.rust.model cimport instrument_id_to_cstr
from bomber.core.rust.model cimport order_list_id_new
from bomber.core.rust.model cimport position_id_new
from bomber.core.rust.model cimport strategy_id_new
from bomber.core.rust.model cimport symbol_is_composite
from bomber.core.rust.model cimport symbol_new
from bomber.core.rust.model cimport symbol_root
from bomber.core.rust.model cimport symbol_topic
from bomber.core.rust.model cimport trade_id_new
from bomber.core.rust.model cimport trade_id_to_cstr
from bomber.core.rust.model cimport trader_id_new
from bomber.core.rust.model cimport venue_code_exists
from bomber.core.rust.model cimport venue_from_cstr_code
from bomber.core.rust.model cimport venue_is_synthetic
from bomber.core.rust.model cimport venue_new
from bomber.core.rust.model cimport venue_order_id_new
...
cdef class InstrumentId(Identifier):
    ...
    def from_pyo3(pyo3_instrument_id) -> InstrumentId:
        ...
        Parameters
        ----------
        value : bomber_pyo3.InstrumentId
    ...
    cpdef to_pyo3(self):
        ...
        Returns
        -------
        bomber_pyo3.InstrumentId

        """
        return bomber_pyo3.InstrumentId.from_str(self.to_str())
...
cpdef InstrumentId new_generic_spread_id(list instrument_ratios):
    ...
    Examples
    --------
    >>> from bomber.model.identifiers import InstrumentId, Symbol, Venue, new_generic_spread_id
...
cpdef list generic_spread_id_to_list(InstrumentId instrument_id):
    ...
    Examples
    --------
    >>> from bomber.model.identifiers import InstrumentId, Symbol, Venue, generic_spread_id_to_list

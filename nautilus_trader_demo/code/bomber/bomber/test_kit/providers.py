...
from bomber.model.currencies import ADA
...
from bomber.model.currencies import XRP
...
from bomber.model.instruments import SyntheticInstrument
...
from bomber.persistence.loaders import CSVBarDataLoader
from bomber.persistence.loaders import CSVTickDataLoader
from bomber.persistence.loaders import ParquetBarDataLoader
...
class TestDataProvider:
    ...
    ----------
    branch : str
        The Bomber GitHub branch for the path.
    ...
    def _test_data_directory() -> str | None:
        ...
        assert source_root.stem == "bomber"
    ...
    def _determine_filesystem(self) -> None:
        ...
        if test_data_dir:
            ...
            self.fs = fsspec.filesystem("github", org="nautechsystems", repo="bomber")
...
def ensure_test_data_exists(filename: str, url: str) -> Path:
    ...
    bomber_pyo3.ensure_file_exists_or_download_http(str(filepath), url, str(checksums_filepath))
    return filepath

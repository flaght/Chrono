...
from bomber.accounting.factory cimport AccountFactory
...
from bomber.model.functions cimport currency_type_from_str
from bomber.model.functions cimport currency_type_to_str
...
from bomber.model.orders.unpacker cimport OrderUnpacker
...
cdef class CacheDatabaseAdapter(CacheDatabaseFacade):
    ...
    def __init__(
        ...
        self._backing = bomber_pyo3.RedisCacheDatabase(
            trader_id=bomber_pyo3.TraderId(trader_id.value),
            instance_id=bomber_pyo3.UUID4.from_str(instance_id.value),

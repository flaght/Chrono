...
from bomber.cache.facade import CacheDatabaseFacade
from bomber.cache.transformers import transform_account_from_pyo3
from bomber.cache.transformers import transform_account_to_pyo3
from bomber.cache.transformers import transform_bar_to_pyo3
from bomber.cache.transformers import transform_currency_from_pyo3
from bomber.cache.transformers import transform_currency_to_pyo3
from bomber.cache.transformers import transform_custom_data_from_pyo3
from bomber.cache.transformers import transform_custom_data_to_pyo3
from bomber.cache.transformers import transform_data_type_to_pyo3
...
from bomber.cache.transformers import transform_order_event_to_pyo3
from bomber.cache.transformers import transform_order_from_pyo3
from bomber.cache.transformers import transform_order_to_pyo3
from bomber.cache.transformers import transform_order_to_snapshot_pyo3
from bomber.cache.transformers import transform_position_to_snapshot_pyo3
from bomber.cache.transformers import transform_quote_tick_to_pyo3
from bomber.cache.transformers import transform_signal_from_pyo3
from bomber.cache.transformers import transform_signal_to_pyo3
from bomber.cache.transformers import transform_trade_tick_from_pyo3
from bomber.cache.transformers import transform_trade_tick_to_pyo3
from bomber.core import bomber_pyo3
from bomber.core.data import Data
from bomber.core.bomber_pyo3 import PostgresCacheDatabase
...
class CachePostgresAdapter(CacheDatabaseFacade):
    ...
    def load_instrument(self, instrument_id: InstrumentId) -> Instrument:
        instrument_id_pyo3 = bomber_pyo3.InstrumentId.from_str(str(instrument_id))
    ...
    def load_order(self, client_order_id: ClientOrderId):
        order_id_pyo3 = bomber_pyo3.ClientOrderId.from_str(str(client_order_id))
    ...
    def load_account(self, account_id: AccountId):
        account_id_pyo3 = bomber_pyo3.AccountId.from_str(str(account_id))
    ...
    ) -> bomber_pyo3.OrderSnapshot | None:
        client_order_id_pyo3 = bomber_pyo3.ClientOrderId.from_str(str(client_order_id))
    ...
    ) -> bomber_pyo3.PositionSnapshot | None:
        position_id_pyo3 = bomber_pyo3.PositionId.from_str(str(position_id))

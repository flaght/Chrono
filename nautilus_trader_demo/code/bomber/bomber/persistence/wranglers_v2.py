...
from bomber.model.objects import FIXED_PRECISION_BYTES
from bomber.model.objects import FIXED_SCALAR
...
class OrderBookDeltaDataWranglerV2(WranglerBase):
    ...
    def __init__(
        ...
        self._inner = bomber_pyo3.OrderBookDeltaDataWrangler(
...
class OrderBookDepth10DataWranglerV2(WranglerBase):
    ...
    def __init__(
        ...
        self._inner = bomber_pyo3.OrderBookDepth10DataWrangler(
            instrument_id=instrument_id,
            price_precision=price_precision,
            size_precision=size_precision,
        )
    ...
    def from_arrow(
        self,
        table: pa.Table,
    ) -> list[bomber_pyo3.OrderBookDepth10]:
        sink = pa.BufferOutputStream()
        writer: pa.RecordBatchStreamWriter = pa.ipc.new_stream(sink, table.schema)
        writer.write_table(table)
        writer.close()
...
class QuoteTickDataWranglerV2(WranglerBase):
    ...
    def __init__(self, instrument_id: str, price_precision: int, size_precision: int) -> None:
        self._inner = bomber_pyo3.QuoteTickDataWrangler(
            instrument_id=instrument_id,
            price_precision=price_precision,
            size_precision=size_precision,
        )
...
class TradeTickDataWranglerV2(WranglerBase):
    ...
    def __init__(
        ...
        self._inner = bomber_pyo3.TradeTickDataWrangler(
            instrument_id=instrument_id,
            price_precision=price_precision,
            size_precision=size_precision,
        )
    ...
    def from_json(
        ...
        return [bomber_pyo3.TradeTick.from_dict(d) for d in data]
...
class BarDataWranglerV2(WranglerBase):
    ...
    def __init__(
        ...
        self._inner = bomber_pyo3.BarDataWrangler(
            bar_type=bar_type,
            price_precision=price_precision,
            size_precision=size_precision,
        )

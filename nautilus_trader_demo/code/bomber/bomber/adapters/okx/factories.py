...
from bomber.core.bomber_pyo3 import OKXContractType
...
def get_cached_okx_http_client(
    ...
    return bomber_pyo3.OKXHttpClient(**kwargs)
...
class OKXLiveDataClientFactory(LiveDataClientFactory):
    ...
    def create(  # type: ignore
        ...
        base_url_http = config.base_url_http or bomber_pyo3.get_okx_http_base_url(region)
        client: bomber_pyo3.OKXHttpClient = get_cached_okx_http_client(

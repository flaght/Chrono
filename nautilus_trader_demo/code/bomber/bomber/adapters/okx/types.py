...
OkxInstrument = (
    bomber_pyo3.CurrencyPair
    | bomber_pyo3.CryptoPerpetual
    | bomber_pyo3.CryptoFuture
    | bomber_pyo3.CryptoFuturesSpread
    | bomber_pyo3.CryptoOption
    | bomber_pyo3.CryptoOptionSpread
    | bomber_pyo3.BinaryOption
)

OKX_INSTRUMENT_TYPES: Final[
    tuple[
        type[bomber_pyo3.CurrencyPair],
        type[bomber_pyo3.CryptoPerpetual],
        type[bomber_pyo3.CryptoFuture],
        type[bomber_pyo3.CryptoFuturesSpread],
        type[bomber_pyo3.CryptoOption],
        type[bomber_pyo3.CryptoOptionSpread],
        type[bomber_pyo3.BinaryOption],
    ]
] = (
    bomber_pyo3.CurrencyPair,
    bomber_pyo3.CryptoPerpetual,

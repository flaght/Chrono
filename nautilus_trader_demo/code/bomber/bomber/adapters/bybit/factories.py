...
from bomber.adapters.bybit.constants import BYBIT_ALL_PRODUCTS
...
def get_cached_bybit_http_client(
    ...
    return bomber_pyo3.BybitHttpClient(**kwargs)
...
class BybitLiveDataClientFactory(LiveDataClientFactory):
    ...
    def create(  # type: ignore
        ...
        client: bomber_pyo3.BybitHttpClient = get_cached_bybit_http_client(
            environment=env,

...
from bomber.data.messages import UnsubscribeInstrumentStatus
...
from bomber.model.enums import BookAction
from bomber.model.enums import BookType
from bomber.model.enums import MarketStatusAction
...
class KrakenDataClient(LiveMarketDataClient):
    ...
    def __init__(
        ...
        self._ws_client_spot_l3: bomber_pyo3.KrakenSpotWebSocketClient | None = None
        if KrakenProductType.SPOT in self._product_types:
            self._ws_client_spot_l3 = bomber_pyo3.KrakenSpotWebSocketClient(
                environment=environment,
    ...
    def _get_ws_client_for_symbol(
        ...
        bomber_pyo3.KrakenSpotWebSocketClient | bomber_pyo3.KrakenFuturesWebSocketClient | None
    ):
        product_type = bomber_pyo3.kraken_product_type_from_symbol(symbol)
        if product_type == KrakenProductType.SPOT:
    ...
    async def _subscribe_l3_order_book(self, command: SubscribeOrderBook) -> None:
        symbol = command.instrument_id.symbol.value
        if bomber_pyo3.kraken_product_type_from_symbol(symbol) != KrakenProductType.SPOT:
            self._log.warning(
    ...
    async def _request_instrument(self, request: RequestInstrument) -> None:
        ...
        for pyo3_instrument in pyo3_instruments:
            ...
            if pyo3_instrument_id == bomber_pyo3.InstrumentId.from_str(
    ...
    async def _request_bars(self, request: RequestBars) -> None:
        ...
        pyo3_bar_type = bomber_pyo3.BarType.from_str(str(bar_type))

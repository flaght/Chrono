...
def get_cached_kraken_spot_http_client(
...
) -> bomber_pyo3.KrakenSpotHttpClient:
    """
    ...
    return bomber_pyo3.KrakenSpotHttpClient(**kwargs)
...
def get_cached_kraken_futures_http_client(
    ...
    proxy_url: str | None = None,
    max_requests_per_second: int | None = None,
) -> bomber_pyo3.KrakenFuturesHttpClient:
    """
    ...
    return bomber_pyo3.KrakenFuturesHttpClient(**kwargs)
...
class KrakenLiveDataClientFactory(LiveDataClientFactory):
    ...
    def create(  # type: ignore
        ...
        http_client_spot: bomber_pyo3.KrakenSpotHttpClient | None = None
        http_client_futures: bomber_pyo3.KrakenFuturesHttpClient | None = None

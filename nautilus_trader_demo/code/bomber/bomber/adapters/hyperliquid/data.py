...
_PYO3HyperliquidAllMids: Any = getattr(bomber_pyo3, "HyperliquidAllMids", None)
...
class HyperliquidDataClient(LiveMarketDataClient):
    ...
    def _custom_instrument_id(
        ...
        *,
        ...
        return bomber_pyo3.InstrumentId.from_str(instrument_id)

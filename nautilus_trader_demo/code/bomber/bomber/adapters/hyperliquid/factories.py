...
from bomber.adapters.hyperliquid.data import HyperliquidDataClient
...
def get_cached_hyperliquid_http_client(
...
) -> bomber_pyo3.HyperliquidHttpClient:
    """
    ...
    return bomber_pyo3.HyperliquidHttpClient(**kwargs)
...
class HyperliquidLiveExecClientFactory(LiveExecClientFactory):
    ...
    def create(  # type: ignore
        ...
        """
        environment = _resolve_environment(config.environment)
        account_address = bomber_pyo3.hyperliquid_resolve_execution_account_address(

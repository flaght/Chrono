...
from bomber.adapters.tardis.common import convert_nautilus_bar_type_to_tardis_data_type
from bomber.adapters.tardis.common import convert_nautilus_data_type_to_tardis_data_type
from bomber.adapters.tardis.common import create_instrument_info
from bomber.adapters.tardis.common import create_replay_normalized_request_options
from bomber.adapters.tardis.common import create_stream_normalized_request_options
from bomber.adapters.tardis.common import get_ws_client_key
from bomber.adapters.tardis.config import TardisDataClientConfig
from bomber.adapters.tardis.constants import TARDIS
from bomber.adapters.tardis.providers import TardisInstrumentProvider
...
class TardisDataClient(LiveMarketDataClient):
    ...
    def __init__(
        ...
        self._ws_client: bomber_pyo3.TardisMachineClient = self._create_websocket_client()
        self._ws_clients: dict[str, bomber_pyo3.TardisMachineClient] = {}
        self._ws_pending_infos: list[bomber_pyo3.TardisInstrumentMiniInfo] = []
        self._ws_pending_streams: list[bomber_pyo3.StreamNormalizedRequestOptions] = []
    ...
    def _create_websocket_client(self) -> bomber_pyo3.TardisMachineClient:
        self._log.info("Creating new TardisMachineClient", LogColor.MAGENTA)
        return bomber_pyo3.TardisMachineClient(

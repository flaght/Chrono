...
class TardisInstrumentProvider(InstrumentProvider):
    ...
    def __init__(
        self,
        client: bomber_pyo3.TardisHttpClient,
    ...
    async def load_all_async(self, filters: dict | None = None) -> None:
        ...
        for venue in venues:
            ...
            for exchange in bomber_pyo3.tardis_exchange_from_venue_str(venue):
                if skip_options and bomber_pyo3.tardis_exchange_is_option_exchange(exchange):
                    continue

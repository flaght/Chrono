...
def get_cached_deribit_http_client(
    ...
    return bomber_pyo3.DeribitHttpClient(**kwargs)
...
class DeribitLiveDataClientFactory(LiveDataClientFactory):
    ...
    def create(  # type: ignore
        ...
        client: bomber_pyo3.DeribitHttpClient = get_cached_deribit_http_client(
...
class DeribitLiveExecClientFactory(LiveExecClientFactory):
    ...
    def create(  # type: ignore
        ...
        """
        environment = config.environment or DeribitEnvironment.MAINNET
        http_client: bomber_pyo3.DeribitHttpClient = get_cached_deribit_http_client(
            api_key=config.api_key,
            api_secret=config.api_secret,
            base_url=config.base_url_http,
            environment=environment,

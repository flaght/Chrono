...
from bomber.adapters.bitmex.types import BITMEX_INSTRUMENT_TYPES
from bomber.adapters.bitmex.types import BitmexInstrument
...
from bomber.core.bomber_pyo3 import BitmexEnvironment
...
from bomber.execution.messages import QueryOrder
...
from bomber.live.cancellation import DEFAULT_FUTURE_CANCELLATION_TIMEOUT
from bomber.live.cancellation import cancel_tasks_with_timeout
from bomber.live.execution_client import LiveExecutionClient
from bomber.model.enums import AccountType
from bomber.model.enums import ContingencyType
...
from bomber.model.functions import contingency_type_to_pyo3
...
from bomber.model.functions import trailing_offset_type_to_pyo3
...
class BitmexExecutionClient(LiveExecutionClient):
    ...
    client : bomber_pyo3.BitMEXHttpClient
    ...
    def __init__(
        ...
        http_url = config.base_url_http or bomber_pyo3.get_bitmex_http_base_url(self._env)
        ...
        self._submitter = bomber_pyo3.SubmitBroadcaster(
        ...
        self._canceller = bomber_pyo3.CancelBroadcaster(
        ...
        # WebSocket API
        ws_url = config.base_url_ws or bomber_pyo3.get_bitmex_ws_url(self._env)

        self._ws_client = bomber_pyo3.BitmexWebSocketClient(
            url=ws_url,
            api_key=config.api_key,
            api_secret=config.api_secret,
    ...
    async def _connect(self) -> None:
        ...
        await self._ws_client.connect(
            ...
            instruments,
            self._handle_msg,
            bomber_pyo3.TraderId(self.trader_id.value),
        )
    ...
    async def _update_account_state(self) -> None:
        ...
        if account_number:
            ...
            self.pyo3_account_id = bomber_pyo3.AccountId(actual_account_id.value)
    ...
    async def _submit_order(self, command: SubmitOrder) -> None:
        ...
        self._ws_client.register_order_identity(
            ...
            strategy_id=bomber_pyo3.StrategyId(order.strategy_id.value),
        ...
        pyo3_display_qty = (
            bomber_pyo3.Quantity.from_str(str(display_qty)) if display_qty is not None else None
        )
        ...
        if order.order_list_id is not None:
            pyo3_order_list_id = bomber_pyo3.OrderListId(order.order_list_id.value)
    ...
    async def _batch_cancel_orders(self, command: BatchCancelOrders) -> None:
        ...
        pyo3_client_order_ids = [
            bomber_pyo3.ClientOrderId.from_str(cid.value) for cid in client_order_ids
        ]
    ...
    def _handle_msg(self, msg: Any) -> None:  # noqa: C901 (too complex)
        try:
            if bomber_pyo3.is_pycapsule(msg):
            ...
            elif isinstance(msg, bomber_pyo3.OrderFilled):
    ...
    def _handle_order_filled_pyo3(self, pyo3_event: bomber_pyo3.OrderFilled) -> None:
    ...
    def _handle_position_status_report_pyo3(
        self,
        pyo3_report: bomber_pyo3.PositionStatusReport,
    ) -> None:

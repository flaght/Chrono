...
from bomber.adapters.bitmex.data import BitmexDataClient
from bomber.adapters.bitmex.execution import BitmexExecClientConfig
...
def get_bitmex_http_client(
    ...
    return bomber_pyo3.BitmexHttpClient(**kwargs)

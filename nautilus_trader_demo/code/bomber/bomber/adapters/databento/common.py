...
def instrument_id_to_pyo3(
    instrument_id: InstrumentId | bomber_pyo3.InstrumentId,
) -> bomber_pyo3.InstrumentId:
    if isinstance(instrument_id, bomber_pyo3.InstrumentId):
        return instrument_id

    return bomber_pyo3.InstrumentId.from_str(instrument_id.value)

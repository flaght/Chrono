...
class DatabentoDataLoader:
    ...
    def __init__(
        ...
        self._pyo3_loader: bomber_pyo3.DatabentoDataLoader = bomber_pyo3.DatabentoDataLoader(
            str(PUBLISHERS_FILEPATH),
        )

        if venue_dataset_map:
            for venue, dataset in venue_dataset_map.items():
                self._pyo3_loader.set_dataset_for_venue(dataset, bomber_pyo3.Venue(venue))
    ...
    def get_publishers(self) -> dict[int, bomber_pyo3.DatabentoPublisher]:
        """
    ...
    def get_dataset_for_venue(self, venue: Venue) -> str:
        ...
        """
        dataset = self._pyo3_loader.get_dataset_for_venue(bomber_pyo3.Venue(venue.value))
    ...
    def from_dbn_file(  # noqa: C901 (too complex)
        ...
        pyo3_instrument_id: bomber_pyo3.InstrumentId | None = (

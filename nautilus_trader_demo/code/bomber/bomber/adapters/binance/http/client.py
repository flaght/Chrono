...
from bomber.adapters.binance.http.error import BinanceServerError
...
from bomber.core.bomber_pyo3 import rsa_signature
...
class BinanceHttpClient:
    ...
    def __init__(
        ...
        self._headers: dict[str, Any] = {
            ...
            "User-Agent": bomber.NAUTILUS_USER_AGENT,
        }

...
from bomber.adapters.polymarket.common.constants import POLYMARKET_HTTP_RATE_LIMIT
from bomber.adapters.polymarket.common.gamma_markets import fetch_fee_schedules
from bomber.adapters.polymarket.common.parsing import parse_polymarket_instrument
from bomber.adapters.polymarket.common.sanitization import extract_resolution_metadata
from bomber.adapters.polymarket.common.sanitization import sanitize_info_for_simulation
...
from bomber.core.bomber_pyo3 import polymarket_trade_id
from bomber.core.bomber_pyo3 import polymarket_trade_sort_key
...
class PolymarketDataLoader:
    ...
    http_client : bomber_pyo3.HttpClient, optional
    ...
    def __init__(
        ...
        http_client: bomber_pyo3.HttpClient | None = None,
    ...
    @staticmethod
    def _create_http_client() -> bomber_pyo3.HttpClient:
        return bomber_pyo3.HttpClient(
            default_quota=bomber_pyo3.Quota.rate_per_minute(POLYMARKET_HTTP_RATE_LIMIT),
        )

    @staticmethod
    async def _fetch_market_by_slug(
        slug: str,
        http_client: bomber_pyo3.HttpClient,
    ) -> dict[str, Any]:

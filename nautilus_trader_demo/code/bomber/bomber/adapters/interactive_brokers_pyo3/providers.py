...
from bomber.adapters.interactive_brokers_pyo3._contracts import IBContractSpec
from bomber.adapters.interactive_brokers_pyo3._contracts import ib_contract_spec_to_dict
from bomber.adapters.interactive_brokers_pyo3._contracts import ib_contract_specs_to_dicts
from bomber.adapters.interactive_brokers_pyo3.config import (
...
try:
    from bomber.core.bomber_pyo3.interactive_brokers import (
...
bomber_pyo3: ModuleType | None
try:
    import bomber.core.bomber_pyo3 as bomber_pyo3
except ImportError:
    bomber_pyo3 = None
...
def _to_pyo3_instrument_id(value: InstrumentId | Any) -> Any:
    if bomber_pyo3 is None or not isinstance(value, InstrumentId):
        return value

    return bomber_pyo3.InstrumentId.from_str(value.value)

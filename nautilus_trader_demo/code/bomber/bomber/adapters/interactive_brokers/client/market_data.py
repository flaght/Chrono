...
from bomber.adapters.interactive_brokers.client.common import BaseMixin
from bomber.adapters.interactive_brokers.client.common import IBKRBookLevel
from bomber.adapters.interactive_brokers.client.common import Subscription
from bomber.adapters.interactive_brokers.common import IBContract
from bomber.adapters.interactive_brokers.parsing.data import IB_SIDE
from bomber.adapters.interactive_brokers.parsing.data import MKT_DEPTH_OPERATIONS
from bomber.adapters.interactive_brokers.parsing.data import bar_spec_to_bar_size
from bomber.adapters.interactive_brokers.parsing.data import generate_trade_id
from bomber.adapters.interactive_brokers.parsing.data import timedelta_to_duration_str
from bomber.adapters.interactive_brokers.parsing.data import what_to_show
...
class InteractiveBrokersClientMarketDataMixin(BaseMixin):
    ...
    async def _process_bar_data(
        ...
        """
        Process received bar data and convert it into Bomber's Bar format. This
        method determines whether the bar is new or a revision of an existing bar and
        converts the bar data to the Bomber's format.
    ...
    async def _process_trade_ticks(self, req_id: int, ticks: list[HistoricalTickLast]) -> None:
        """
        Process received trade tick data, convert it to Bomber TradeTick type,
    ...
    async def _ib_bar_to_nautilus_bar(
        ...
        """
        Convert Interactive Brokers bar data to Bomber's bar type.

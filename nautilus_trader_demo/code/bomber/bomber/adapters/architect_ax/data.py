...
class AxDataClient(LiveMarketDataClient):
    ...
    def __init__(
        ...
        self._ws_client: bomber_pyo3.AxMdWebSocketClient | None = None

        if config.base_url_ws:
            self._ws_url = config.base_url_ws
        elif config.environment == bomber_pyo3.AxEnvironment.SANDBOX:
    ...
    async def _connect(self) -> None:
        ...
        self._ws_client = bomber_pyo3.AxMdWebSocketClient.without_auth(
            url=self._ws_url,
            heartbeat=20,
    ...
    def _get_pyo3_instrument_id(
        ...
        return bomber_pyo3.InstrumentId.from_str(str(instrument_id))
    ...
    async def _subscribe_order_book_deltas(self, command: SubscribeOrderBook) -> None:
        ...
        if command.book_type == BookType.L3_MBO:
            level = bomber_pyo3.AxMarketDataLevel.LEVEL3
        elif command.book_type == BookType.L2_MBP:
            level = bomber_pyo3.AxMarketDataLevel.LEVEL2
        else:
            self._log.warning(

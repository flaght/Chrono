...
from bomber.adapters.architect_ax.constants import AX_SUPPORTED_ORDER_TYPES
from bomber.adapters.architect_ax.constants import AX_VENUE
from bomber.adapters.architect_ax.constants import AX_WS_ORDERS_PRODUCTION_URL
from bomber.adapters.architect_ax.constants import AX_WS_ORDERS_SANDBOX_URL
...
class AxExecutionClient(LiveExecutionClient):
    ...
    client : bomber_pyo3.AxHttpClient
    ...
    def __init__(
        ...
        self.pyo3_trader_id = bomber_pyo3.TraderId(self.trader_id.value)
        ...
        self._ws_orders_client: bomber_pyo3.AxOrdersWebSocketClient | None = None
    ...
    async def _connect(self) -> None:
        ...
        try:
            ...
            self._ws_orders_client = bomber_pyo3.AxOrdersWebSocketClient(
    ...
    async def generate_order_status_report(
        ...
        if order is not None:
            ...
            pyo3_side = bomber_pyo3.OrderSide.NO_ORDER_SIDE
            pyo3_type = bomber_pyo3.OrderType.LIMIT
            pyo3_tif = bomber_pyo3.TimeInForce.GTC
    ...
    async def _get_market_order_price(self, order: Order) -> bomber_pyo3.Price | None:
        pyo3_instrument_id = bomber_pyo3.InstrumentId.from_str(order.instrument_id.value)
        pyo3_quantity = bomber_pyo3.Quantity.from_str(str(order.quantity))
        pyo3_side = order_side_to_pyo3(order.side)
    ...
    def _handle_msg(self, msg: Any) -> None:
        if isinstance(msg, bomber_pyo3.OrderAccepted):
    ...
    def _handle_order_accepted(self, msg: bomber_pyo3.OrderAccepted) -> None:
    ...
    def _handle_order_filled(self, msg: bomber_pyo3.OrderFilled) -> None:
    ...
    def _handle_order_canceled(self, msg: bomber_pyo3.OrderCanceled) -> None:
    ...
    def _handle_order_expired(self, msg: bomber_pyo3.OrderExpired) -> None:
    ...
    def _handle_order_rejected(self, msg: bomber_pyo3.OrderRejected) -> None:
    ...
    def _handle_order_cancel_rejected(self, msg: bomber_pyo3.OrderCancelRejected) -> None:
    ...
    def _handle_order_status_report(self, msg: bomber_pyo3.OrderStatusReport) -> None:
    ...
    def _handle_fill_report(self, msg: bomber_pyo3.FillReport) -> None:

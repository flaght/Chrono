...
class DydxDataClient(LiveMarketDataClient):
    ...
    client : bomber_pyo3.DydxHttpClient
    ...
    def __init__(
        self,
        loop: asyncio.AbstractEventLoop,
        client: bomber_pyo3.DydxHttpClient,  # type: ignore[name-defined]
        msgbus: MessageBus,
        cache: Cache,
        clock: LiveClock,
        instrument_provider: DydxInstrumentProvider,
        ...
        ws_url = config.base_url_ws or bomber_pyo3.get_dydx_ws_url(self._network)  # type: ignore[attr-defined]
        self._ws_client = bomber_pyo3.DydxWebSocketClient.new_public(  # type: ignore[attr-defined]
            url=ws_url,
            heartbeat=20,
    ...
    def _handle_msg(self, capsule: object) -> None:
        try:
            if bomber_pyo3.is_pycapsule(capsule):
    ...
    def _handle_market_data_update(self, capsule: object) -> bool:
        if isinstance(capsule, bomber_pyo3.MarkPriceUpdate):

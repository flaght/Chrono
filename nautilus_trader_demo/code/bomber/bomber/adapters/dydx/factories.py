...
def get_cached_dydx_http_client(
...
) -> bomber_pyo3.DydxHttpClient:  # type: ignore[name-defined]
    """
    ...
    """
    return bomber_pyo3.DydxHttpClient(  # type: ignore[attr-defined]
        base_url=base_url,
        network=network,
        proxy_url=proxy_url,
    )
...
class DydxLiveDataClientFactory(LiveDataClientFactory):
    ...
    def create(  # type: ignore
        ...
        client: bomber_pyo3.DydxHttpClient = get_cached_dydx_http_client(  # type: ignore[name-defined]

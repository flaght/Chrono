...
from bomber.core.fsm import InvalidStateTrigger
from bomber.core.message import Command
from bomber.core.uuid import UUID4
from bomber.execution.client import ExecutionClient
from bomber.execution.engine import ExecutionEngine
from bomber.execution.messages import GenerateExecutionMassStatus
...
from bomber.execution.reports import ExecutionReport
...
from bomber.live.reconciliation import adjust_fills_for_partial_window
from bomber.live.reconciliation import calculate_reconciliation_price
from bomber.live.reconciliation import create_inferred_order_filled_event
from bomber.live.reconciliation import create_order_accepted_event
from bomber.live.reconciliation import create_order_canceled_event
from bomber.live.reconciliation import create_order_expired_event
from bomber.live.reconciliation import create_order_filled_event
from bomber.live.reconciliation import create_order_rejected_event
from bomber.live.reconciliation import create_order_triggered_event
from bomber.live.reconciliation import create_order_updated_event
from bomber.live.reconciliation import get_existing_fill_for_trade_id
from bomber.live.reconciliation import is_within_single_unit_tolerance
from bomber.model.book import py_should_handle_own_book_order
...
from bomber.model.events import OrderEvent
...
from bomber.model.orders import OrderUnpacker
...
class LiveExecutionEngine(ExecutionEngine):
    ...
    def _create_synthetic_reconciliation_venue_order_id(
        ...
        pyo3_venue_order_id = bomber_pyo3.create_position_reconciliation_venue_order_id(
            bomber_pyo3.AccountId(account_id.value),
            bomber_pyo3.InstrumentId.from_str(instrument_id.value),
            bomber_pyo3.OrderSide(order_side.name),
            bomber_pyo3.OrderType(order_type.name),
            bomber_pyo3.Quantity.from_str(str(quantity)),
            bomber_pyo3.Price.from_str(str(price)) if price else None,
            bomber_pyo3.PositionId(venue_position_id.value) if venue_position_id else None,
            ts_last,
            tag,
        )

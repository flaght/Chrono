...
from bomber.core.rust.common import ComponentState as PyComponentState
...
from bomber.core.datetime cimport dt_to_unix_nanos
from bomber.core.datetime cimport maybe_dt_to_unix_nanos
from bomber.core.fsm cimport FiniteStateMachine
from bomber.core.fsm cimport InvalidStateTrigger
from bomber.core.message cimport Event
from bomber.core.rust.common cimport ComponentState
from bomber.core.rust.common cimport ComponentTrigger
from bomber.core.rust.common cimport LogColor
from bomber.core.rust.common cimport LogGuard_API
from bomber.core.rust.common cimport LogLevel
from bomber.core.rust.common cimport TimeEventHandler_t
from bomber.core.rust.common cimport component_state_from_cstr
from bomber.core.rust.common cimport component_state_to_cstr
from bomber.core.rust.common cimport component_trigger_from_cstr
from bomber.core.rust.common cimport component_trigger_to_cstr
from bomber.core.rust.common cimport is_matching_ffi
from bomber.core.rust.common cimport live_clock_cancel_callbacks
from bomber.core.rust.common cimport live_clock_cancel_default_handler
from bomber.core.rust.common cimport live_clock_cancel_timer
from bomber.core.rust.common cimport live_clock_drop
from bomber.core.rust.common cimport live_clock_new
from bomber.core.rust.common cimport live_clock_next_time
from bomber.core.rust.common cimport live_clock_register_default_handler
from bomber.core.rust.common cimport live_clock_set_time_alert
from bomber.core.rust.common cimport live_clock_set_timer
from bomber.core.rust.common cimport live_clock_timer_count
from bomber.core.rust.common cimport live_clock_timer_names
from bomber.core.rust.common cimport live_clock_timestamp
from bomber.core.rust.common cimport live_clock_timestamp_ms
from bomber.core.rust.common cimport live_clock_timestamp_ns
from bomber.core.rust.common cimport live_clock_timestamp_us
from bomber.core.rust.common cimport log_color_from_cstr
from bomber.core.rust.common cimport log_color_to_cstr
from bomber.core.rust.common cimport log_level_from_cstr
from bomber.core.rust.common cimport log_level_to_cstr
from bomber.core.rust.common cimport logger_drop
from bomber.core.rust.common cimport logger_flush
from bomber.core.rust.common cimport logger_log
from bomber.core.rust.common cimport logging_clock_set_realtime_mode
from bomber.core.rust.common cimport logging_clock_set_static_mode
from bomber.core.rust.common cimport logging_clock_set_static_time
from bomber.core.rust.common cimport logging_init_with_options
from bomber.core.rust.common cimport logging_is_initialized
from bomber.core.rust.common cimport logging_log_header
from bomber.core.rust.common cimport logging_log_sysinfo
from bomber.core.rust.common cimport logging_sync_to_disk
from bomber.core.rust.common cimport test_clock_advance_time
from bomber.core.rust.common cimport test_clock_cancel_callbacks
from bomber.core.rust.common cimport test_clock_cancel_default_handler
from bomber.core.rust.common cimport test_clock_cancel_timer
from bomber.core.rust.common cimport test_clock_cancel_timers
from bomber.core.rust.common cimport test_clock_drop
from bomber.core.rust.common cimport test_clock_new
from bomber.core.rust.common cimport test_clock_next_time
from bomber.core.rust.common cimport test_clock_register_default_handler
from bomber.core.rust.common cimport test_clock_set_time
from bomber.core.rust.common cimport test_clock_set_time_alert
from bomber.core.rust.common cimport test_clock_set_timer
from bomber.core.rust.common cimport test_clock_timer_count
from bomber.core.rust.common cimport test_clock_timer_names
from bomber.core.rust.common cimport test_clock_timestamp
from bomber.core.rust.common cimport test_clock_timestamp_ms
from bomber.core.rust.common cimport test_clock_timestamp_ns
from bomber.core.rust.common cimport test_clock_timestamp_us
from bomber.core.rust.common cimport time_event_new
from bomber.core.rust.common cimport time_event_to_cstr
...
from bomber.core.rust.core cimport uuid4_from_cstr
from bomber.core.string cimport cstr_to_pystr
from bomber.core.string cimport pybytes_to_cstr
...
from bomber.model.identifiers cimport Identifier
from bomber.model.identifiers cimport TraderId
from bomber.serialization.base cimport _EXTERNAL_PUBLISHABLE_TYPES
from bomber.serialization.base cimport Serializer
...
cdef class Logger:
    ...
    cpdef void debug(
        ...
        """
        if LOGGING_PYO3:
            bomber_pyo3.logger_log(
                bomber_pyo3.LogLevel.DEBUG,
                bomber_pyo3.LogColor(log_color_to_str(color)),
                self._name,
                message,
            )
            return
...
cdef class MessageBus:
    ...
    database : bomber_pyo3.RedisMessageBusDatabase, optional
    ...
    def __init__(
        ...
        database: bomber_pyo3.RedisMessageBusDatabase | None = None,
    ...
    cpdef void add_listener(self, listener: bomber_pyo3.MessageBusListener):
        """
        Adds the given listener to the message bus.

        Parameters
        ----------
        listener : bomber_pyo3.MessageBusListener
            The listener to add.

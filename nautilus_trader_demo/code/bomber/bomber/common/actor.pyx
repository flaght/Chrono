...
from bomber.common.executor import ActorExecutor
from bomber.common.executor import TaskId
from bomber.common.signal import generate_signal_class
...
from bomber.common.component cimport SENT
...
from bomber.indicators.base cimport Indicator
...
# -- ABSTRACT METHODS -----------------------------------------------------------------------------
    ...
    cpdef void on_order_book_deltas(self, deltas):
        ...
        Parameters
        ----------
        deltas : OrderBookDeltas or bomber_pyo3.OrderBookDeltas
...
# -- SUBSCRIPTIONS --------------------------------------------------------------------------------
    ...
    cpdef void subscribe_order_book_deltas(
        ...
        pyo3_conversion : bool, default False
            If received deltas should be converted to `bomber_pyo3.OrderBookDeltas`
    ...
    cpdef void subscribe_order_book_depth(
        ...
        managed : bool, default True
            If an order book should be managed by the data engine based on the subscribed feed.
        pyo3_conversion : bool, default False
            If received deltas should be converted to `bomber_pyo3.OrderBookDepth`
...
# -- HANDLERS -------------------------------------------------------------------------------------
    ...
    cpdef void handle_order_book_deltas(self, deltas, bint historical=False):
        ...
        The `deltas` will be `bomber_pyo3.OrderBookDeltas` if the

...
from bomber.core.datetime import min_date
from bomber.core.datetime import time_object_to_dt
from bomber.data.config import DataEngineConfig
from bomber.model.enums import RecordFlag
from bomber.persistence.catalog import BaseDataCatalog
from bomber.persistence.funcs import parse_filters_expr
...
from bomber.common.component cimport CMD
from bomber.common.component cimport RECV
from bomber.common.component cimport REQ
from bomber.common.component cimport RES
...
from bomber.common.data_topics cimport TopicCache
...
from bomber.core.rust.core cimport NANOSECONDS_IN_MILLISECOND
from bomber.core.rust.core cimport NANOSECONDS_IN_SECOND
...
from bomber.data.aggregation cimport BarAggregator
from bomber.data.aggregation cimport RenkoBarAggregator
from bomber.data.aggregation cimport SpreadQuoteAggregator
from bomber.data.aggregation cimport TickBarAggregator
from bomber.data.aggregation cimport TickImbalanceBarAggregator
from bomber.data.aggregation cimport TickRunsBarAggregator
from bomber.data.aggregation cimport TimeBarAggregator
from bomber.data.aggregation cimport ValueBarAggregator
from bomber.data.aggregation cimport ValueImbalanceBarAggregator
from bomber.data.aggregation cimport ValueRunsBarAggregator
from bomber.data.aggregation cimport VolumeBarAggregator
from bomber.data.aggregation cimport VolumeImbalanceBarAggregator
from bomber.data.aggregation cimport VolumeRunsBarAggregator
from bomber.data.client cimport DataClient
from bomber.data.client cimport MarketDataClient
from bomber.data.engine cimport SnapshotInfo
...
from bomber.data.messages cimport RequestJoin
from bomber.data.messages cimport RequestOrderBookDeltas
from bomber.data.messages cimport RequestOrderBookDepth
...
from bomber.data.messages cimport SubscribeOptionChain
...
from bomber.data.messages cimport UnsubscribeOptionChain
...
from bomber.model.data cimport FundingRateUpdate
from bomber.model.data cimport IndexPriceUpdate
from bomber.model.data cimport InstrumentClose
from bomber.model.data cimport InstrumentStatus
from bomber.model.data cimport MarkPriceUpdate
from bomber.model.data cimport OptionGreeks
...
from bomber.model.data cimport bar_aggregation_not_implemented_message

from bomber.model.enums import ContinuousFutureAdjustmentType

from bomber.model.greeks cimport GreeksCalculator
...
cdef class DataEngine(Component):
    ...
    cpdef bint _is_backtest_client(self, DataClient client):
        ...
        # `bomber.data` and `bomber.backtest`.
        from bomber.backtest.data_client import BacktestMarketDataClient
    ...
    cdef void _create_option_chain_manager(self, SubscribeOptionChain command, object initial_atm_price):
        ...
        for inst in instruments:
            ...
            try:
                ...
                resolved[bomber_pyo3.InstrumentId.from_str(str(inst.id))] = (
                    bomber_pyo3.Price.from_str(str(strike)),
                    kind_u8,
                )
        ...
        if strike_range is None:
            ...
            strike_range = bomber_pyo3.StrikeRange.fixed(strikes)

        # Create OptionChainManager via PyO3
        manager = bomber_pyo3.OptionChainManager(
        ...
        for fp in forward_prices:
            ...
            if inst is not None:
                if (hasattr(inst, 'expiration_ns') and inst.expiration_ns == series_id.expiration_ns
                    ...
                    initial_atm_price = bomber_pyo3.Price.from_str(str(fp.forward_price))
                    break
...
# -- OPTION CHAIN FEED METHODS -------------------------------------------------------------------
    ...
    cdef void _expire_option_chain_instrument(self, InstrumentId instrument_id, str series_key):
        ...
        # Remove from manager
        pyo3_id = bomber_pyo3.InstrumentId.from_str(str(instrument_id))
    ...
    cdef void _update_option_chains(self, Instrument instrument):
        ...
        try:
            pyo3_series_id = bomber_pyo3.OptionSeriesId(
                venue_str,
                underlying_str,
                settlement_str,
                expiration_ns,
        ...
        pyo3_id = bomber_pyo3.InstrumentId.from_str(str(instrument.id))
        pyo3_strike = bomber_pyo3.Price.from_str(str(instrument.strike_price))

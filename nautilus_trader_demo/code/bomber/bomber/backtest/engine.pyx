...
from bomber.accounting.error import AccountError
from bomber.backtest.results import BacktestResult
from bomber.common.component import is_logging_pyo3
...
from bomber.core.inspect import is_nautilus_class
from bomber.core.rust.model import OtoTriggerMode
from bomber.data.engine import TimeRangeGenerator
from bomber.data.engine import get_time_range_generator
from bomber.model import BOOK_DATA_TYPES
from bomber.model import NAUTILUS_PYO3_DATA_TYPES
from bomber.system.kernel import NautilusKernel
from bomber.trading.trader import Trader
...
from bomber.accounting.margin_models cimport LeveragedMarginModel
from bomber.accounting.margin_models cimport MarginModel
from bomber.backtest.data_client cimport BacktestDataClient
from bomber.backtest.data_client cimport BacktestMarketDataClient
from bomber.backtest.execution_client cimport BacktestExecClient
from bomber.backtest.models cimport FeeModel
from bomber.backtest.models cimport FillModel
from bomber.backtest.models cimport LatencyModel
from bomber.backtest.models cimport MakerTakerFeeModel
from bomber.backtest.modules cimport SimulationModule
from bomber.cache.base cimport CacheFacade
from bomber.common.actor cimport Actor
from bomber.common.component cimport FORCE_STOP
from bomber.common.component cimport LOGGING_PYO3
from bomber.common.component cimport LogColor
from bomber.common.component cimport Logger
from bomber.common.component cimport LogGuard
from bomber.common.component cimport MessageBus
from bomber.common.component cimport TestClock
from bomber.common.component cimport TimeEvent
from bomber.common.component cimport flush_logger
from bomber.common.component cimport get_component_clocks
from bomber.common.component cimport is_logging_initialized
from bomber.common.component cimport log_sysinfo
from bomber.common.component cimport set_backtest_force_stop
from bomber.common.component cimport set_logging_clock_realtime_mode
from bomber.common.component cimport set_logging_clock_static_mode
from bomber.common.component cimport set_logging_clock_static_time
from bomber.core.correctness cimport Condition
from bomber.core.data cimport Data
from bomber.core.datetime cimport format_iso8601
from bomber.core.datetime cimport format_optional_iso8601
from bomber.core.datetime cimport maybe_dt_to_unix_nanos
from bomber.core.datetime cimport unix_nanos_to_dt
from bomber.core.rust.backtest cimport TimeEventAccumulator_API
from bomber.core.rust.backtest cimport time_event_accumulator_advance_clock
from bomber.core.rust.backtest cimport time_event_accumulator_clear
from bomber.core.rust.backtest cimport time_event_accumulator_drop
from bomber.core.rust.backtest cimport time_event_accumulator_new
from bomber.core.rust.backtest cimport time_event_accumulator_peek_next_time
from bomber.core.rust.backtest cimport time_event_accumulator_pop_next_at_or_before
from bomber.core.rust.common cimport TimeEventHandler_t
from bomber.core.rust.common cimport logging_is_colored
from bomber.core.rust.common cimport time_event_handler_drop
from bomber.core.rust.common cimport vec_time_event_handlers_drop
from bomber.core.rust.core cimport CVec
from bomber.core.rust.model cimport FIXED_PRECISION
from bomber.core.rust.model cimport PRICE_RAW_MAX
from bomber.core.rust.model cimport PRICE_RAW_MIN
...
from bomber.core.rust.model cimport BookLevel_API
from bomber.core.rust.model cimport BookType
...
from bomber.core.rust.model cimport MarketStatus
from bomber.core.rust.model cimport MarketStatusAction
from bomber.core.rust.model cimport OmsType
from bomber.core.rust.model cimport OptionKind
from bomber.core.rust.model cimport OrderSide
from bomber.core.rust.model cimport OrderStatus
from bomber.core.rust.model cimport OrderType
from bomber.core.rust.model cimport OtoTriggerMode
...
from bomber.core.rust.model cimport level_price
from bomber.core.rust.model cimport level_size_raw
from bomber.core.rust.model cimport orderbook_asks_up_to
from bomber.core.rust.model cimport orderbook_best_ask_price
from bomber.core.rust.model cimport orderbook_best_bid_price
from bomber.core.rust.model cimport orderbook_bids_down_to
from bomber.core.rust.model cimport orderbook_has_ask
from bomber.core.rust.model cimport orderbook_has_bid
from bomber.core.rust.model cimport orderbook_ts_last
from bomber.core.rust.model cimport trade_id_new
from bomber.core.rust.model cimport vec_drop_book_levels
from bomber.core.string cimport pystr_to_cstr
from bomber.core.uuid cimport UUID4
from bomber.data.messages cimport DataCommand
from bomber.data.messages cimport DataResponse
...
from bomber.execution.algorithm cimport ExecAlgorithm
from bomber.execution.matching_core cimport MatchingCore
...
from bomber.execution.trailing cimport TrailingStopCalculator
from bomber.model.book cimport BookLevel
from bomber.model.book cimport OrderBook
from bomber.model.data cimport Bar
from bomber.model.data cimport BarType
from bomber.model.data cimport CustomData
...
from bomber.model.data cimport OrderBookDepth10
from bomber.model.data cimport QuoteTick
from bomber.model.data cimport TradeTick
from bomber.model.data cimport compute_bar_quarter_sizes
...
from bomber.model.functions cimport account_type_to_str
from bomber.model.functions cimport aggressor_side_to_str
from bomber.model.functions cimport book_type_to_str
from bomber.model.functions cimport oms_type_to_str
from bomber.model.functions cimport order_type_to_str
from bomber.model.functions cimport time_in_force_to_str
...
from bomber.model.instruments.base cimport ENGINE_EXPIRING_INSTRUMENT_CLASSES
...
from bomber.model.orders.limit_if_touched cimport LimitIfTouchedOrder
from bomber.model.orders.market cimport MarketOrder
from bomber.model.orders.market_if_touched cimport MarketIfTouchedOrder
from bomber.model.orders.market_to_limit cimport MarketToLimitOrder
from bomber.model.orders.stop_limit cimport StopLimitOrder
from bomber.model.orders.stop_market cimport StopMarketOrder
...
cdef class BacktestEngine:
    ...
    def get_log_guard(self) -> bomber_pyo3.LogGuard | LogGuard | None:
        """
        ...
        Returns
        -------
        bomber_pyo3.LogGuard | LogGuard | None
    ...
    def end(self):
        ...
        if LOGGING_PYO3:
            bomber_pyo3.logging_clock_set_realtime_mode()

        self._log_post_run()

        if LOGGING_PYO3:
            bomber_pyo3.logger_flush()
        else:
            flush_logger()
    ...
    def _run(
        ...
        if self._iteration == 0:
            ...
            if LOGGING_PYO3:
                bomber_pyo3.logging_clock_set_static_mode()
                bomber_pyo3.logging_clock_set_static_time(start_ns)
    ...
    cdef CVec _advance_time(self, uint64_t ts_now):
        ...
        while ts_now > 0:
            ...
            if LOGGING_PYO3:
                bomber_pyo3.logging_clock_set_static_time(ts_event)
        ...
        if LOGGING_PYO3:
            bomber_pyo3.logging_clock_set_static_time(ts_now)
    ...
    def _log_pre_run(self):
        if is_logging_pyo3():
            bomber_pyo3.log_sysinfo(component=type(self).__name__)
        else:

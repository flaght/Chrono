...
from kichaos.stable3.common.vec_env import VecNormalize
...
def fit(index, train_data, val_data, variant):
    ...
    env_normal_train = VecNormalize(env_train, norm_reward=True)
    env_train = env_normal_train
    ...
    env_normal_val = VecNormalize(env_val, norm_reward=False)
    env_val = env_normal_val

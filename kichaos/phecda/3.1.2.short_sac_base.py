...
from kichaos.envs.trader.cn_futures.hedge022 import Hedge022TraderEnv as HedgeTraderEnv
...
def fit(index, train_data, val_data, variant):
    ...
    total_timesteps = math.ceil(
        params['step_len'] * params['check_freq'] / 10000) * 10000
...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_days', type=int, default=30)  ## 训练天数

...
from kichaos.agent.liaison.liaison0007 import Liaison0007  # as Liaison
from kichaos.agent.liaison.liaison0006 import Liaison0006 #as Liaison
from kichaos.agent.pawn.pawn0006 import Pawn0006  #as Pawn
from kichaos.envs.trader.cn_futures.hedge013 import Hedge013TraderEnv as HedgeTraderEnv
...
STATE_CLASS_MAPPING = {1: Liaison0007, 2: Liaison0006}
...
def educate(index, test_data, variant):
    ...
    model_path = os.path.join(g_train_path, agent_model_name, "model1000")
